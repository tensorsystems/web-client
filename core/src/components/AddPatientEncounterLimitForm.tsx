...
import {
  MutationSavePatientEncounterLimitArgs,
  PatientEncounterLimitInput,
  Query,
...
export const AddPatientEncounterLimitForm: React.FC<Props> = ({
  ...
  const onSubmit = (data: PatientEncounterLimitInput) => {
    save({
      variables: {
        input: data,
      },
