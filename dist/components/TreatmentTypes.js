...
`;
export const TreatmentTypesComponent = ({ onItemClick }) => {
    var _a;
    ...
    return (_jsxs("div", Object.assign({ className: "overflow-hidden rounded-lg shadow-xl" }, { children: [_jsxs("table", Object.assign({ className: "w-full" }, { children: [_jsxs("thead", { children: [_jsx("tr", { children: _jsx("th", Object.assign({ scope: "col", colSpan: 2, className: "px-4 py-2 bg-teal-700 text-left text-xs text-gray-50 uppercase tracking-wider" }, { children: "Treatments list" }), void 0) }, void 0),
            ...
            _jsx(TablePagination, { totalCount: (_a = data === null || data === void 0 ? void 0 : data.treatmentTypes.totalCount) !== null && _a !== void 0 ? _a : 0, onNext: handleNextClick, onPrevious: handlePreviousClick }, void 0)] }), void 0));
};
