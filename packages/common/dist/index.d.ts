...
declare const BILLINGS: _apollo_client.DocumentNode;
declare const SUPPLIES: _apollo_client.DocumentNode;
declare const FIND_TODAYS_CHECKED_IN_APPOINTMENTS: _apollo_client.DocumentNode;
declare const MEDICATION_PRESCRIPTIONS: _apollo_client.DocumentNode;
declare const vitalSignsFragment: _apollo_client.DocumentNode;
declare const SHOULD_PAY_FOR_CONSULTATION: _apollo_client.DocumentNode;

declare type Action$1 = {
    type: "show";
    children: any;
    snapPoint: number;
} | {
...
declare type Dispatch$1 = (action: Action$1) => void;
...
declare function useBottonSheetState(): State$1;
declare function useBottomSheetDispatch(): Dispatch$1;
...
declare type AllergyUpdateInput = {
    id: Scalars["ID"];
...
declare type AmendmentFilter = {
    patientChartId?: InputMaybe<Scalars["ID"]>;
};
declare type AmendmentInput = {
    patientChartId: Scalars["ID"];
    note: Scalars["String"];
};
declare type AmendmentUpdateInput = {
    id: Scalars["ID"];
...
declare type AppointmentConnection = Connection & {
    __typename?: "AppointmentConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<AppointmentEdge>;
};
declare type AppointmentEdge = {
    __typename?: "AppointmentEdge";
    node: Appointment;
};
declare type AppointmentFilter = {
    id?: InputMaybe<Scalars["ID"]>;
...
declare type AppointmentSearchInput = {
...
declare type AppointmentStatusConnection = Connection & {
    __typename?: "AppointmentStatusConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<Maybe<AppointmentStatusEdge>>;
};
declare type AppointmentStatusEdge = {
    __typename?: "AppointmentStatusEdge";
    node: AppointmentStatus;
};
declare type AppointmentStatusInput = {
    title: Scalars["String"];
};
declare type AppointmentUpdateInput = {
    id: Scalars["ID"];
    patientId?: InputMaybe<Scalars["ID"]>;
    checkInTime?: InputMaybe<Scalars["Time"]>;
    checkedInTime?: InputMaybe<Scalars["Time"]>;
...
declare type BillingConnection = Connection & {
    __typename?: "BillingConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<Maybe<BillingEdge>>;
};
declare type BillingEdge = {
    __typename?: "BillingEdge";
    node: Billing;
};
declare type BillingFilter = {
    item?: InputMaybe<Scalars["String"]>;
    code?: InputMaybe<Scalars["String"]>;
};
declare type BillingInput = {
    item: Scalars["String"];
    code: Scalars["String"];
    price: Scalars["Float"];
    credit: Scalars["Boolean"];
...
declare type ChatMessageInput = {
    body: Scalars["String"];
    chatId: Scalars["ID"];
};
declare type ChatMute = {
    __typename?: "ChatMute";
    id: Scalars["ID"];
    chatId: Scalars["ID"];
    userId: Scalars["ID"];
...
declare type ChatUnreadMessage = {
...
declare type ChiefComplaintConnection = Connection & {
    __typename?: "ChiefComplaintConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<Maybe<ChiefComplaintEdge>>;
};
declare type ChiefComplaintEdge = {
    __typename?: "ChiefComplaintEdge";
    node: ChiefComplaint;
};
declare type ChiefComplaintFilter = {
    id?: InputMaybe<Scalars["ID"]>;
    title?: InputMaybe<Scalars["String"]>;
    patientChartId?: InputMaybe<Scalars["ID"]>;
};
declare type ChiefComplaintInput = {
    title: Scalars["String"];
    patientChartId: Scalars["ID"];
    hpiComponentIds: Array<InputMaybe<Scalars["ID"]>>;
};
declare type ChiefComplaintOrder = {
    field: Scalars["String"];
    direction: OrderDirection;
};
declare type ChiefComplaintType = {
    __typename?: "ChiefComplaintType";
    id: Scalars["ID"];
    title: Scalars["String"];
    active: Scalars["Boolean"];
};
declare type ChiefComplaintTypeConnection = Connection & {
    __typename?: "ChiefComplaintTypeConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<Maybe<ChiefComplaintTypeEdge>>;
};
declare type ChiefComplaintTypeEdge = {
    __typename?: "ChiefComplaintTypeEdge";
    node: ChiefComplaintType;
};
declare type ChiefComplaintTypeInput = {
    title: Scalars["String"];
};
declare type ChiefComplaintTypeUpdateInput = {
    id: Scalars["ID"];
    title: Scalars["String"];
};
declare type ChiefComplaintUpdateInput = {
    id: Scalars["ID"];
    title?: InputMaybe<Scalars["String"]>;
    patientChartId?: InputMaybe<Scalars["ID"]>;
    hpiComponentIds?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
};
declare type ConfirmFollowOrderInput = {
    orderId: Scalars["ID"];
    checkInTime: Scalars["Time"];
    roomId: Scalars["ID"];
};
declare type ConfirmFollowUpOrderInput = {
...
declare type ConfirmFollowUpOrderResult = {
...
declare type ConfirmReferralOrderInput = {
...
declare type ConfirmReferralOrderResult = {
...
declare type ConfirmSurgicalOrderInput = {
...
declare type ConfirmTreatmentOrderResult = {
...
declare type DiagnosisConnection = Connection & {
    __typename?: "DiagnosisConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<Maybe<DiagnosisEdge>>;
};
declare type DiagnosisEdge = {
    __typename?: "DiagnosisEdge";
    node: Diagnosis;
};
declare type DiagnosisInput = {
...
declare type DiagnosisOrder = {
    field: Scalars["String"];
    direction: OrderDirection;
};
declare type DiagnosisUpdateInput = {
    id: Scalars["ID"];
    categoryCode?: InputMaybe<Scalars["String"]>;
    diagnosisCode?: InputMaybe<Scalars["String"]>;
    abbreviatedDescription?: InputMaybe<Scalars["String"]>;
...
declare type DiagnosticProcedure = {
...
declare type DiagnosticProcedureConnection = Connection & {
    __typename?: "DiagnosticProcedureConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<Maybe<DiagnosticProcedureEdge>>;
};
declare type DiagnosticProcedureDeleteFileInput = {
    diagnosticProcedureId: Scalars["ID"];
    fileId: Scalars["ID"];
};
declare type DiagnosticProcedureEdge = {
    __typename?: "DiagnosticProcedureEdge";
    node: DiagnosticProcedure;
};
declare type DiagnosticProcedureFilter = {
    patientChartId?: InputMaybe<Scalars["ID"]>;
};
declare type DiagnosticProcedureInput = {
    patientChartId: Scalars["ID"];
    diagnosticProcedureOrderId: Scalars["ID"];
...
declare type DiagnosticProcedureOrder = {
...
declare type DiagnosticProcedureOrderConnection = Connection & {
    __typename?: "DiagnosticProcedureOrderConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<DiagnosticProcedureOrderEdge>;
};
declare type DiagnosticProcedureOrderEdge = {
    __typename?: "DiagnosticProcedureOrderEdge";
    node: DiagnosticProcedureOrder;
};
declare type DiagnosticProcedureOrderFilter = {
    patientChartId?: InputMaybe<Scalars["ID"]>;
    orderedById?: InputMaybe<Scalars["ID"]>;
    patientId?: InputMaybe<Scalars["ID"]>;
    status?: InputMaybe<Scalars["String"]>;
};
declare enum DiagnosticProcedureOrderStatus {
    Ordered = "ORDERED",
    Completed = "COMPLETED"
}
declare type DiagnosticProcedureOrderUpdateInput = {
    id: Scalars["ID"];
    patientChartId?: InputMaybe<Scalars["ID"]>;
    patientId?: InputMaybe<Scalars["ID"]>;
...
declare enum DiagnosticProcedureStatus {
    Ordered = "ORDERED",
    Completed = "COMPLETED"
}
declare type DiagnosticProcedureType = {
...
declare type ExamCategory = {
    __typename?: "ExamCategory";
    id: Scalars["ID"];
    title: Scalars["String"];
    active: Scalars["Boolean"];
};
declare type ExamCategoryConnection = Connection & {
    __typename?: "ExamCategoryConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<ExamCategoryEdge>;
};
declare type ExamCategoryEdge = {
    __typename?: "ExamCategoryEdge";
    node: ExamCategory;
};
declare type ExamCategoryInput = {
    title: Scalars["String"];
};
declare type ExamCategoryUpdateInput = {
    id: Scalars["ID"];
    title?: InputMaybe<Scalars["String"]>;
};
declare type ExamFinding = {
...
declare type ExamFindingConnection = Connection & {
    __typename?: "ExamFindingConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<ExamFindingEdge>;
};
declare type ExamFindingEdge = {
    __typename?: "ExamFindingEdge";
    node: ExamFinding;
};
declare type ExamFindingInput = {
    title: Scalars["String"];
    pertinence: Scalars["Boolean"];
    examCategoryId: Scalars["ID"];
};
declare type ExamFindingUpdateInput = {
    id: Scalars["ID"];
    title?: InputMaybe<Scalars["String"]>;
    pertinence?: InputMaybe<Scalars["Boolean"]>;
    examCategoryId?: InputMaybe<Scalars["ID"]>;
};
declare type EyewearPrescription = {
...
declare type EyewearPrescriptionOrder = {
...
declare type EyewearPrescriptionOrderConnection = Connection & {
    __typename?: "EyewearPrescriptionOrderConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<EyewearPrescriptionOrderEdge>;
};
declare type EyewearPrescriptionOrderEdge = {
    __typename?: "EyewearPrescriptionOrderEdge";
    node: EyewearPrescriptionOrder;
};
declare type EyewearPrescriptionOrderUpdateInput = {
    id: Scalars["ID"];
    pharmacyId?: InputMaybe<Scalars["ID"]>;
    status?: InputMaybe<Scalars["String"]>;
};
declare type EyewearPrescriptionUpdateInput = {
    id: Scalars["ID"];
    glass?: InputMaybe<Scalars["Boolean"]>;
    plastic?: InputMaybe<Scalars["Boolean"]>;
    singleVision?: InputMaybe<Scalars["Boolean"]>;
...
declare type EyewearShopConnection = Connection & {
    __typename?: "EyewearShopConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<Maybe<EyewearShopEdge>>;
};
declare type EyewearShopEdge = {
    __typename?: "EyewearShopEdge";
    node: EyewearShop;
};
declare type EyewearShopInput = {
    title: Scalars["String"];
    address: Scalars["String"];
    region: Scalars["String"];
    country: Scalars["String"];
...
declare type EyewearShopUpdateInput = {
    id: Scalars["ID"];
    title?: InputMaybe<Scalars["String"]>;
...
declare type FamilyIllnessInput = {
    title: Scalars["String"];
    description: Scalars["String"];
    patientHistoryId: Scalars["ID"];
};
declare type FamilyIllnessUpdateInput = {
    id: Scalars["ID"];
    description?: InputMaybe<Scalars["String"]>;
    title?: InputMaybe<Scalars["String"]>;
};
declare type FavoriteChiefComplaint = {
...
declare type FavoriteDiagnosis = {
...
declare type FavoriteMedication = {
...
declare type FavoriteMedicationUpdateInput = {
    id: Scalars["ID"];
    medication?: InputMaybe<Scalars["String"]>;
    sig?: InputMaybe<Scalars["String"]>;
    refill?: InputMaybe<Scalars["Int"]>;
...
declare type FileConnection = Connection & {
...
declare type FollowUpConnection = Connection & {
    __typename?: "FollowUpConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<FollowUpEdge>;
};
declare type FollowUpEdge = {
    __typename?: "FollowUpEdge";
    node: FollowUp;
};
declare type FollowUpFilter = {
    patientChartId?: InputMaybe<Scalars["ID"]>;
};
declare type FollowUpInput = {
    followUpOrderId: Scalars["ID"];
    patientChartId: Scalars["ID"];
    status: FollowUpStatus;
};
declare type FollowUpOrder = {
...
declare type FollowUpOrderConnection = Connection & {
    __typename?: "FollowUpOrderConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<FollowUpOrderEdge>;
};
declare type FollowUpOrderEdge = {
    __typename?: "FollowUpOrderEdge";
    node: FollowUpOrder;
};
declare type FollowUpOrderFilter = {
    patientChartId?: InputMaybe<Scalars["ID"]>;
    orderedById?: InputMaybe<Scalars["ID"]>;
    patientId?: InputMaybe<Scalars["ID"]>;
    status?: InputMaybe<Scalars["String"]>;
};
declare enum FollowUpOrderStatus {
    Ordered = "ORDERED",
    Completed = "COMPLETED"
}
declare enum FollowUpStatus {
    Ordered = "ORDERED",
    Completed = "COMPLETED"
}
declare type FollowUpUpdateInput = {
    id: Scalars["ID"];
    status?: InputMaybe<FollowUpStatus>;
};
declare type HealthCheckReport = {
    __typename?: "HealthCheckReport";
    health: Scalars["String"];
    db: Scalars["Boolean"];
};
declare type HomeStats = {
    __typename?: "HomeStats";
    scheduled: Scalars["Int"];
    checkedIn: Scalars["Int"];
    checkedOut: Scalars["Int"];
};
declare type HpiComponent = {
...
declare type HpiComponentConnection = Connection & {
    __typename?: "HpiComponentConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<Maybe<HpiComponentEdge>>;
};
declare type HpiComponentEdge = {
    __typename?: "HpiComponentEdge";
    node: HpiComponent;
};
declare type HpiComponentInput = {
    title: Scalars["String"];
    hpiComponentTypeId: Scalars["ID"];
};
declare type HpiComponentType = {
    __typename?: "HpiComponentType";
    id: Scalars["ID"];
    title: Scalars["String"];
    description: Scalars["String"];
};
declare type HpiComponentTypeConnection = Connection & {
    __typename?: "HpiComponentTypeConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<Maybe<HpiComponentTypeEdge>>;
};
declare type HpiComponentTypeEdge = {
    __typename?: "HpiComponentTypeEdge";
    node: HpiComponentType;
};
declare type HpiComponentTypeInput = {
    title: Scalars["String"];
    description: Scalars["String"];
};
declare type HpiComponentTypeOrder = {
    field: Scalars["String"];
    direction: OrderDirection;
};
declare type HpiComponentTypeUpdateInput = {
    id: Scalars["ID"];
    title: Scalars["String"];
    description: Scalars["String"];
};
declare type HpiComponentUpdateInput = {
    id: Scalars["ID"];
    title?: InputMaybe<Scalars["String"]>;
    hpiComponentTypeId?: InputMaybe<Scalars["ID"]>;
};
declare type HpiFilter = {
    id?: InputMaybe<Scalars["ID"]>;
    title?: InputMaybe<Scalars["String"]>;
    hpiComponentTypeId?: InputMaybe<Scalars["ID"]>;
};
...
declare type LabConnection = Connection & {
    __typename?: "LabConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<Maybe<LabEdge>>;
};
declare type LabDeleteFileInput = {
    labId: Scalars["ID"];
    fileId: Scalars["ID"];
};
declare type LabEdge = {
    __typename?: "LabEdge";
    node: Lab;
};
declare type LabFilter = {
    patientChartId?: InputMaybe<Scalars["ID"]>;
};
declare type LabInput = {
    patientChartId: Scalars["ID"];
    labOrderId: Scalars["ID"];
...
declare type LabOrderConnection = Connection & {
    __typename?: "LabOrderConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<LabOrderEdge>;
};
declare type LabOrderEdge = {
    __typename?: "LabOrderEdge";
    node: LabOrder;
};
declare type LabOrderFilter = {
    patientChartId?: InputMaybe<Scalars["ID"]>;
    orderedById?: InputMaybe<Scalars["ID"]>;
    patientId?: InputMaybe<Scalars["ID"]>;
    status?: InputMaybe<Scalars["String"]>;
};
declare enum LabOrderStatus {
    Ordered = "ORDERED",
    Completed = "COMPLETED"
}
declare type LabOrderUpdateInput = {
    id: Scalars["ID"];
    patientChartId?: InputMaybe<Scalars["ID"]>;
    patientId?: InputMaybe<Scalars["ID"]>;
    firstName?: InputMaybe<Scalars["String"]>;
...
declare type LabTypeConnection = Connection & {
    __typename?: "LabTypeConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<Maybe<LabTypeEdge>>;
};
declare type LabTypeEdge = {
    __typename?: "LabTypeEdge";
    node: LabType;
};
declare type LabTypeInput = {
    title: Scalars["String"];
    active: Scalars["Boolean"];
    billingIds: Array<InputMaybe<Scalars["ID"]>>;
};
declare type LabTypeUpdateInput = {
    id: Scalars["ID"];
    title?: InputMaybe<Scalars["String"]>;
    active?: InputMaybe<Scalars["Boolean"]>;
    billingIds?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
};
declare type LabUpdateInput = {
    id: Scalars["ID"];
    cbcWbcActive?: InputMaybe<Scalars["Boolean"]>;
    cbcWbcResults?: InputMaybe<Scalars["String"]>;
    cbcWbcDate?: InputMaybe<Scalars["Time"]>;
...
declare type LifestyleInput = {
    title: Scalars["String"];
    description: Scalars["String"];
    note: Scalars["String"];
    patientHistoryId: Scalars["ID"];
};
declare type LifestyleType = {
    __typename?: "LifestyleType";
    id: Scalars["ID"];
    title: Scalars["String"];
};
declare type LifestyleTypeConnection = Connection & {
    __typename?: "LifestyleTypeConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<Maybe<LifestyleTypeEdge>>;
};
declare type LifestyleTypeEdge = {
    __typename?: "LifestyleTypeEdge";
    node: LifestyleType;
};
declare type LifestyleTypeInput = {
    title: Scalars["String"];
};
declare type LifestyleTypeUpdateInput = {
    id: Scalars["ID"];
    title: Scalars["String"];
};
declare type LifestyleUpdateInput = {
    id: Scalars["ID"];
    title?: InputMaybe<Scalars["String"]>;
    note?: InputMaybe<Scalars["String"]>;
    description?: InputMaybe<Scalars["String"]>;
...
declare type MedicalPrescription = {
...
declare type MedicalPrescriptionInput = {
    patientId: Scalars["ID"];
    medication: Scalars["String"];
    rxCui?: InputMaybe<Scalars["String"]>;
    synonym?: InputMaybe<Scalars["String"]>;
...
declare type MedicalPrescriptionOrder = {
...
declare type MedicalPrescriptionUpdateInput = {
    id: Scalars["ID"];
    pharmacyId?: InputMaybe<Scalars["ID"]>;
    medication?: InputMaybe<Scalars["String"]>;
    rxCui?: InputMaybe<Scalars["String"]>;
...
declare type MedicationPrescriptionUpdateInput = {
    id: Scalars["ID"];
    pharmacyId?: InputMaybe<Scalars["ID"]>;
    status?: InputMaybe<Scalars["String"]>;
};
...
declare type MutationCreateTodoArgs = {
    input: NewTodo;
};
declare type MutationSaveAllergyArgs = {
    input: AllergyInput;
};
declare type MutationUpdateAllergyArgs = {
    input: AllergyUpdateInput;
};
declare type MutationDeleteAllergyArgs = {
    id: Scalars["ID"];
};
declare type MutationCreateAmendmentArgs = {
    input: AmendmentInput;
};
declare type MutationUpdateAmendmentArgs = {
    input: AmendmentUpdateInput;
};
declare type MutationDeleteAmendmentArgs = {
    id: Scalars["ID"];
};
declare type MutationNewAppointmentArgs = {
    input: AppointmentInput;
};
declare type MutationUpdateAppointmentArgs = {
    input: AppointmentUpdateInput;
};
declare type MutationDeleteAppointmentArgs = {
    id: Scalars["ID"];
};
declare type MutationSaveAppointmentStatusArgs = {
    input: AppointmentStatusInput;
};
declare type MutationUpdateAppointmentStatusArgs = {
    input: AppointmentStatusInput;
    id: Scalars["ID"];
};
declare type MutationDeleteAppointmentStatusArgs = {
    id: Scalars["ID"];
};
declare type MutationSaveBillingArgs = {
    input: BillingInput;
};
declare type MutationUpdateBillingArgs = {
    input: BillingInput;
    id: Scalars["ID"];
};
declare type MutationDeleteBillingArgs = {
    id: Scalars["ID"];
};
declare type MutationCreateChatArgs = {
    input: ChatInput;
};
declare type MutationSendMessageArgs = {
    input: ChatMessageInput;
};
declare type MutationMuteChatArgs = {
    id: Scalars["ID"];
};
declare type MutationUnmuteChatArgs = {
    id: Scalars["ID"];
};
declare type MutationDeleteChatArgs = {
    id: Scalars["ID"];
};
declare type MutationDeleteUnreadMessagesArgs = {
    userId: Scalars["ID"];
    chatId: Scalars["ID"];
};
declare type MutationSaveChiefComplaintArgs = {
    input: ChiefComplaintInput;
};
declare type MutationUpdateChiefComplaintArgs = {
    input: ChiefComplaintUpdateInput;
};
declare type MutationDeleteChiefComplaintArgs = {
    id: Scalars["ID"];
};
declare type MutationSavePatientChiefComplaintArgs = {
    input: ChiefComplaintInput;
};
declare type MutationDeletePatientChiefComplaintArgs = {
    id: Scalars["ID"];
};
declare type MutationSaveChiefComplaintTypeArgs = {
    input: ChiefComplaintTypeInput;
};
declare type MutationUpdateChiefComplaintTypeArgs = {
    input: ChiefComplaintTypeUpdateInput;
};
declare type MutationDeleteChiefComplaintTypeArgs = {
    id: Scalars["ID"];
};
declare type MutationSaveDiagnosisArgs = {
    input: DiagnosisInput;
};
declare type MutationUpdateDiagnosisArgs = {
    input: DiagnosisUpdateInput;
};
declare type MutationDeleteDiagnosisArgs = {
    id: Scalars["ID"];
};
declare type MutationOrderDiagnosticProcedureArgs = {
    input: OrderDiagnosticProcedureInput;
};
declare type MutationOrderAndConfirmDiagnosticProcedureArgs = {
    input: OrderAndConfirmDiagnosticProcedureInput;
};
declare type MutationConfirmDiagnosticProcedureOrderArgs = {
    id: Scalars["ID"];
    invoiceNo: Scalars["String"];
};
declare type MutationUpdateDiagnosticProcedureOrderArgs = {
    input: DiagnosticProcedureOrderUpdateInput;
};
declare type MutationSaveDiagnosticProcedureArgs = {
    input: DiagnosticProcedureInput;
};
declare type MutationUpdateDiagnosticProcedureArgs = {
    input: DiagnosticProcedureUpdateInput;
};
declare type MutationDeleteDiagnosticProcedureArgs = {
    id: Scalars["ID"];
};
declare type MutationSaveDiagnosticProcedureTypeArgs = {
    input: DiagnosticProcedureTypeInput;
};
declare type MutationUpdateDiagnosticProcedureTypeArgs = {
    input: DiagnosticProcedureTypeUpdateInput;
};
declare type MutationDeleteDiagnosticProcedureTypeArgs = {
    id: Scalars["ID"];
};
declare type MutationDeleteDiagnosticImageArgs = {
    input: DiagnosticProcedureDeleteFileInput;
};
declare type MutationDeleteDiagnosticRightEyeImageArgs = {
    input: DiagnosticProcedureDeleteFileInput;
};
declare type MutationDeleteDiagnosticLeftEyeImageArgs = {
    input: DiagnosticProcedureDeleteFileInput;
};
declare type MutationDeleteDiagnosticRightEyeSketchArgs = {
    input: DiagnosticProcedureDeleteFileInput;
};
declare type MutationDeleteDiagnosticLeftEyeSketchArgs = {
    input: DiagnosticProcedureDeleteFileInput;
};
declare type MutationDeleteDiagnosticDocumentArgs = {
    input: DiagnosticProcedureDeleteFileInput;
};
declare type MutationCreateEyewearShopArgs = {
    input: EyewearShopInput;
};
declare type MutationUpdateEyewearShopArgs = {
    input: EyewearShopUpdateInput;
};
declare type MutationDeleteEyewearShopArgs = {
    id: Scalars["ID"];
};
declare type MutationSaveFavoriteChiefComplaintArgs = {
    chiefComplaintTypeId: Scalars["ID"];
};
declare type MutationDeleteFavoriteChiefComplaintArgs = {
    id: Scalars["ID"];
};
declare type MutationSaveFavoriteDiagnosisArgs = {
    diagnosisId: Scalars["ID"];
};
declare type MutationDeleteFavoriteDiagnosisArgs = {
    id: Scalars["ID"];
};
declare type MutationSaveFavoriteMedicationArgs = {
    input: FavoriteMedicationInput;
};
declare type MutationUpdateFavoriteMedicationArgs = {
    input: FavoriteMedicationUpdateInput;
};
declare type MutationDeleteFavoriteMedicationArgs = {
    id: Scalars["ID"];
};
declare type MutationSaveFileArgs = {
    input: FileInput;
};
declare type MutationUpdateFileArgs = {
    input: FileUpdateInput;
};
declare type MutationDeleteFileArgs = {
    id: Scalars["ID"];
};
declare type MutationOrderFollowUpArgs = {
    input: OrderFollowUpInput;
};
declare type MutationConfirmFollowUpOrderArgs = {
    input: ConfirmFollowUpOrderInput;
};
declare type MutationDeleteFollowUpArgs = {
    id: Scalars["ID"];
};
declare type MutationSaveFollowUpArgs = {
    input: FollowUpInput;
};
declare type MutationUpdateFollowUpArgs = {
    input: FollowUpUpdateInput;
};
declare type MutationSaveHpiComponentTypeArgs = {
    input: HpiComponentTypeInput;
};
declare type MutationUpdateHpiComponentTypeArgs = {
    input: HpiComponentTypeUpdateInput;
};
declare type MutationDeleteHpiComponentTypeArgs = {
    id: Scalars["ID"];
};
declare type MutationSaveHpiComponentArgs = {
    input: HpiComponentInput;
};
declare type MutationUpdateHpiComponentArgs = {
    input: HpiComponentUpdateInput;
};
declare type MutationDeleteHpiComponentArgs = {
    id: Scalars["ID"];
};
declare type MutationSaveLabArgs = {
    input: LabInput;
};
declare type MutationUpdateLabArgs = {
    input: LabUpdateInput;
};
declare type MutationDeleteLabArgs = {
    id: Scalars["ID"];
};
declare type MutationSaveLabTypeArgs = {
    input: LabTypeInput;
};
declare type MutationUpdateLabTypeArgs = {
    input: LabTypeUpdateInput;
};
declare type MutationDeleteLabTypeArgs = {
    id: Scalars["ID"];
};
declare type MutationDeleteLabRightEyeImageArgs = {
    input: LabDeleteFileInput;
};
declare type MutationDeleteLabLeftEyeImageArgs = {
    input: LabDeleteFileInput;
};
declare type MutationDeleteLabRightEyeSketchArgs = {
    input: LabDeleteFileInput;
};
declare type MutationDeleteLabLeftEyeSketchArgs = {
    input: LabDeleteFileInput;
};
declare type MutationDeleteLabImageArgs = {
    input: LabDeleteFileInput;
};
declare type MutationDeleteLabDocumentArgs = {
    input: LabDeleteFileInput;
};
declare type MutationOrderLabArgs = {
    input: OrderLabInput;
};
declare type MutationConfirmLabOrderArgs = {
    id: Scalars["ID"];
    invoiceNo: Scalars["String"];
};
declare type MutationUpdateLabOrderArgs = {
    input: LabOrderUpdateInput;
};
declare type MutationOrderAndConfirmLabArgs = {
    input: OrderAndConfirmLabInput;
};
declare type MutationSaveLifestyleTypesArgs = {
    input: LifestyleTypeInput;
};
declare type MutationUpdateLifestyleTypeArgs = {
    input: LifestyleTypeUpdateInput;
};
declare type MutationDeleteLifestyleTypeArgs = {
    id: Scalars["ID"];
};
declare type MutationSaveOrderArgs = {
    input: OrderInput;
};
declare type MutationUpdateOrderArgs = {
    input: OrderUpdateInput;
};
declare type MutationDeleteOrderArgs = {
    id: Scalars["ID"];
};
declare type MutationOrderFollowupArgs = {
    input: OrderFollowupInput;
};
declare type MutationScheduleSurgeryArgs = {
    input: ScheduleSurgeryInput;
};
declare type MutationScheduleTreatmentArgs = {
    input: ScheduleTreatmentInput;
};
declare type MutationConfirmOrderArgs = {
    orderId: Scalars["ID"];
    invoiceNo: Scalars["String"];
};
declare type MutationSaveOrganizationDetailsArgs = {
    input: OrganizationDetailsInput;
};
declare type MutationSavePastIllnessTypesArgs = {
    input: PastIllnessTypeInput;
};
declare type MutationUpdatePastIllnessTypeArgs = {
    input: PastIllnessTypeUpdateInput;
};
declare type MutationDeletePastIllnessTypeArgs = {
    id: Scalars["ID"];
};
declare type MutationSavePatientArgs = {
    input: PatientInput;
};
declare type MutationUpdatePatientArgs = {
    input: PatientUpdateInput;
};
declare type MutationDeletePatientArgs = {
    id: Scalars["ID"];
};
declare type MutationSavePatientChartArgs = {
    input: PatientChartInput;
};
declare type MutationUpdatePatientChartArgs = {
    input: PatientChartUpdateInput;
};
declare type MutationDeletePatientChartArgs = {
    id: Scalars["ID"];
};
declare type MutationLockPatientChartArgs = {
    id: Scalars["ID"];
};
declare type MutationSaveVitalSignsArgs = {
    input: VitalSignsInput;
};
declare type MutationUpdateVitalSignsArgs = {
    input: VitalSignsUpdateInput;
};
declare type MutationSaveOphthalmologyExamArgs = {
    input: OpthalmologyExamInput;
};
declare type MutationUpdateOphthalmologyExamArgs = {
    input: OpthalmologyExamUpdateInput;
};
declare type MutationSavePatientDiagnosisArgs = {
    input: PatientDiagnosisInput;
};
declare type MutationUpdatePatientDiagnosisArgs = {
    input: PatientDiagnosisUpdateInput;
};
declare type MutationDeletePatientDiagnosisArgs = {
    id: Scalars["ID"];
};
declare type MutationSavePatientEncounterLimitArgs = {
    input: PatientEncounterLimitInput;
};
declare type MutationUpdatePatientEncounterLimitArgs = {
    input: PatientEncounterLimitUpdateInput;
};
declare type MutationDeletePatientEncounterLimitArgs = {
    id: Scalars["ID"];
};
declare type MutationSavePastIllnessArgs = {
    input: PastIllnessInput;
};
declare type MutationSavePastInjuryArgs = {
    input: PastInjuryInput;
};
declare type MutationSavePastHospitalizationArgs = {
    input: PastHospitalizationInput;
};
declare type MutationSavePastSurgeryArgs = {
    input: PastSurgeryInput;
};
declare type MutationSaveLifestyleArgs = {
    input: LifestyleInput;
};
declare type MutationSaveFamilyIllnessArgs = {
    input: FamilyIllnessInput;
};
declare type MutationUpdatePatientHistoryArgs = {
    input: PatientHistoryUpdateInput;
};
declare type MutationUpdatePastIllnessArgs = {
    input: PastIllnessUpdateInput;
};
declare type MutationUpdatePastInjuryArgs = {
    input: PastInjuryUpdateInput;
};
declare type MutationUpdatePastHospitalizationArgs = {
    input: PastHospitalizationUpdateInput;
};
declare type MutationUpdatePastSurgeryArgs = {
    input: PastSurgeryUpdateInput;
};
declare type MutationUpdateLifestyleArgs = {
    input: LifestyleUpdateInput;
};
declare type MutationUpdateFamilyIllnessArgs = {
    input: FamilyIllnessUpdateInput;
};
declare type MutationDeletePastIllnessArgs = {
    id: Scalars["ID"];
};
declare type MutationDeletePastInjuryArgs = {
    id: Scalars["ID"];
};
declare type MutationDeletePastHospitalizationArgs = {
    id: Scalars["ID"];
};
declare type MutationDeletePastSurgeryArgs = {
    id: Scalars["ID"];
};
declare type MutationDeleteLifestyleArgs = {
    id: Scalars["ID"];
};
declare type MutationDeleteFamilyIllnessArgs = {
    id: Scalars["ID"];
};
declare type MutationSubscribeQueueArgs = {
    userId: Scalars["ID"];
    patientQueueId: Scalars["ID"];
};
declare type MutationUnsubscribeQueueArgs = {
    userId: Scalars["ID"];
    patientQueueId: Scalars["ID"];
};
declare type MutationSavePatientQueueArgs = {
    input: PatientQueueInput;
};
declare type MutationDeleteFromQueueArgs = {
    patientQueueId: Scalars["ID"];
    appointmentId: Scalars["ID"];
};
declare type MutationCheckOutPatientArgs = {
    patientQueueId: Scalars["ID"];
    appointmentId: Scalars["ID"];
};
declare type MutationPushPatientQueueArgs = {
    patientQueueId: Scalars["ID"];
    appointmentId: Scalars["ID"];
    destination: Destination;
};
declare type MutationMovePatientQueueArgs = {
    appointmentId: Scalars["ID"];
    sourceQueueId: Scalars["ID"];
    destinationQueueId: Scalars["ID"];
};
declare type MutationCheckInPatientArgs = {
    appointmentId: Scalars["ID"];
    destination: Destination;
};
declare type MutationUpdatePatientQueueArgs = {
    appointmentId: Scalars["ID"];
    destination?: InputMaybe<Destination>;
};
declare type MutationSavePaymentArgs = {
    input: PaymentInput;
};
declare type MutationUpdatePaymentArgs = {
    input: PaymentInput;
};
declare type MutationDeletePaymentArgs = {
    id: Scalars["ID"];
};
declare type MutationConfirmPaymentArgs = {
    id: Scalars["ID"];
    invoiceNo: Scalars["String"];
};
declare type MutationConfirmPaymentsArgs = {
    ids: Array<Scalars["ID"]>;
    invoiceNo: Scalars["String"];
};
declare type MutationRequestPaymentWaiverArgs = {
    paymentId: Scalars["ID"];
    patientId: Scalars["ID"];
};
declare type MutationRequestPaymentWaiversArgs = {
    ids: Array<Scalars["ID"]>;
    patientId: Scalars["ID"];
};
declare type MutationSavePaymentWaiverArgs = {
    input: PaymentWaiverInput;
};
declare type MutationUpdatePaymentWaiverArgs = {
    input: PaymentWaiverUpdateInput;
};
declare type MutationDeletePaymentWaiverArgs = {
    id: Scalars["ID"];
};
declare type MutationApprovePaymentWaiverArgs = {
    id: Scalars["ID"];
    approve: Scalars["Boolean"];
};
declare type MutationCreatePharmacyArgs = {
    input: PharmacyInput;
};
declare type MutationUpdatePharmacyArgs = {
    input: PharmacyUpdateInput;
};
declare type MutationDeletePharmacyArgs = {
    id: Scalars["ID"];
};
declare type MutationSaveExamCategoryArgs = {
    input: ExamCategoryInput;
};
declare type MutationUpdateExamCategoryArgs = {
    input: ExamCategoryUpdateInput;
};
declare type MutationSaveExamFindingArgs = {
    input: ExamFindingInput;
};
declare type MutationUpdateExamFindingArgs = {
    input: ExamFindingUpdateInput;
};
declare type MutationSavePhysicalExamFindingArgs = {
    input: PhysicalExamFindingInput;
};
declare type MutationUpdatePhysicalExamFindingArgs = {
    input: PhysicalExamFindingUpdateInput;
};
declare type MutationDeletePhysicalExamFindingArgs = {
    id: Scalars["ID"];
};
declare type MutationDeletePhysicalExamFindingExamCategoryArgs = {
    physicalExamFindingId: Scalars["ID"];
    examCategoryId: Scalars["ID"];
};
declare type MutationSavePlanTypeArgs = {
    input: PlanTypeInput;
};
declare type MutationUpdatePlanTypeArgs = {
    input: PlanTypeInput;
    id: Scalars["ID"];
};
declare type MutationDeletePlanTypeArgs = {
    id: Scalars["ID"];
};
declare type MutationSaveMedicationPrescriptionArgs = {
    input: MedicalPrescriptionOrderInput;
};
declare type MutationSavePastMedicationArgs = {
    input: MedicalPrescriptionInput;
};
declare type MutationSaveEyewearPrescriptionArgs = {
    input: EyewearPrescriptionInput;
};
declare type MutationUpdateMedicationPrescriptionArgs = {
    input: MedicalPrescriptionUpdateInput;
};
declare type MutationUpdateEyewearPrescriptionArgs = {
    input: EyewearPrescriptionUpdateInput;
};
declare type MutationDeleteMedicalPrescriptionArgs = {
    id: Scalars["ID"];
};
declare type MutationDeleteEyewearPrescriptionArgs = {
    id: Scalars["ID"];
};
declare type MutationUpdateMedicationPrescriptionOrderArgs = {
    input: MedicationPrescriptionUpdateInput;
};
declare type MutationUpdateEyewearPrescriptionOrderArgs = {
    input: EyewearPrescriptionOrderUpdateInput;
};
declare type MutationOrderReferralArgs = {
    input: OrderReferralInput;
};
declare type MutationConfirmReferralOrderArgs = {
    input: ConfirmReferralOrderInput;
};
declare type MutationDeleteReferralArgs = {
    id: Scalars["ID"];
};
declare type MutationSaveSystemArgs = {
    input: SystemInput;
};
declare type MutationUpdateSystemArgs = {
    input: SystemUpdateInput;
};
declare type MutationSaveSystemSymptomArgs = {
    input: SystemSymptomInput;
};
declare type MutationUpdateSystemSymptomArgs = {
    input: SystemSymptomUpdateInput;
};
declare type MutationSaveReviewOfSystemArgs = {
    input: ReviewOfSystemInput;
};
declare type MutationUpdateReviewOfSystemArgs = {
    input: ReviewOfSystemUpdateInput;
};
declare type MutationDeleteReviewOfSystemArgs = {
    id: Scalars["ID"];
};
declare type MutationSaveRoomArgs = {
    input: RoomInput;
};
declare type MutationUpdateRoomArgs = {
    input: RoomInput;
    id: Scalars["ID"];
};
declare type MutationDeleteRoomArgs = {
    id: Scalars["ID"];
};
declare type MutationSaveSupplyArgs = {
    input: SupplyInput;
};
declare type MutationUpdateSupplyArgs = {
    input: SupplyUpdateInput;
};
declare type MutationDeleteSupplyArgs = {
    id: Scalars["ID"];
};
declare type MutationOrderSurgicalProcedureArgs = {
    input: OrderSurgicalInput;
};
declare type MutationConfirmSurgicalOrderArgs = {
    input: ConfirmSurgicalOrderInput;
};
declare type MutationSaveSurgicalProcedureArgs = {
    input: SurgicalProcedureInput;
};
declare type MutationUpdateSurgicalProcedureArgs = {
    input: SurgicalProcedureUpdateInput;
};
declare type MutationDeleteSurgicalProcedureArgs = {
    id: Scalars["ID"];
};
declare type MutationSaveSurgicalProcedureTypeArgs = {
    input: SurgicalProcedureTypeInput;
};
declare type MutationUpdateSurgicalProcedureTypeArgs = {
    input: SurgicalProcedureTypeUpdateInput;
};
declare type MutationDeleteSurgicalProcedureTypeArgs = {
    id: Scalars["ID"];
};
declare type MutationDeletePreanestheticDocumentArgs = {
    surgicalProcedureId: Scalars["ID"];
    fileId: Scalars["ID"];
};
declare type MutationUpdateSurgeryFitnessArgs = {
    id: Scalars["ID"];
    fit: Scalars["Boolean"];
};
declare type MutationOrderAndConfirmSurgeryArgs = {
    input: OrderAndConfirmSurgicalProcedureInput;
};
declare type MutationOrderTreatmentArgs = {
    input: OrderTreatmentInput;
};
declare type MutationConfirmTreatmentOrderArgs = {
    input: ConfirmTreatmentOrderInput;
};
declare type MutationSaveTreatmentArgs = {
    input: TreatmentInput;
};
declare type MutationUpdateTreatmentArgs = {
    input: TreatmentUpdateInput;
};
declare type MutationDeleteTreatmentArgs = {
    id: Scalars["ID"];
};
declare type MutationSaveTreatmentTypeArgs = {
    input: TreatmentTypeInput;
};
declare type MutationUpdateTreatmentTypeArgs = {
    input: TreatmentTypeUpdateInput;
};
declare type MutationDeleteTreatmentTypeArgs = {
    id: Scalars["ID"];
};
declare type MutationSignupArgs = {
    input: UserInput;
};
...
declare type MutationChangePasswordArgs = {
    input: ChangePasswordInput;
};
declare type MutationSaveUserTypeArgs = {
    input: UserTypeInput;
};
declare type MutationUpdateUserTypeArgs = {
    input: UserTypeUpdateInput;
};
declare type MutationDeleteUserTypeArgs = {
    id: Scalars["ID"];
};
declare type MutationSaveVisitTypeArgs = {
    input: VisitTypeInput;
};
declare type MutationUpdateVisitTypeArgs = {
    input: VisitTypeInput;
    id: Scalars["ID"];
};
declare type MutationDeleteVisitTypeArgs = {
    id: Scalars["ID"];
};
...
declare enum NotifType {
    Chat = "CHAT"
}
declare type OphthalmologyExamFilter = {
    id?: InputMaybe<Scalars["ID"]>;
    patientChartId?: InputMaybe<Scalars["ID"]>;
};
declare type OpthalmologyExam = {
...
declare type OpthalmologyExamInput = {
    patientChartId: Scalars["ID"];
...
declare type OpthalmologyExamUpdateInput = {
    id: Scalars["ID"];
    rightOrbits?: InputMaybe<Scalars["String"]>;
    leftOrbits?: InputMaybe<Scalars["String"]>;
    rightLids?: InputMaybe<Scalars["String"]>;
...
declare type OrderAndConfirmDiagnosticProcedureInput = {
    appointmentId: Scalars["ID"];
    patientId: Scalars["ID"];
...
declare type OrderAndConfirmLabInput = {
    appointmentId: Scalars["ID"];
    patientId: Scalars["ID"];
...
declare type OrderAndConfirmSurgicalProcedureInput = {
...
declare type OrderConnection = Connection & {
    __typename?: "OrderConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<Maybe<OrderEdge>>;
};
declare type OrderDiagnosticProcedureInput = {
    diagnosticProcedureTypeId: Scalars["ID"];
    patientChartId: Scalars["ID"];
    appointmentId: Scalars["ID"];
    patientId: Scalars["ID"];
...
declare type OrderEdge = {
    __typename?: "OrderEdge";
    node: Order;
};
declare type OrderFilterInput = {
    userId?: InputMaybe<Scalars["ID"]>;
...
declare type OrderFollowupInput = {
    appointmentId: Scalars["ID"];
    note?: InputMaybe<Scalars["String"]>;
};
declare type OrderFollowUpInput = {
...
declare type OrderReferralInput = {
    patientChartId: Scalars["ID"];
    patientId: Scalars["ID"];
    receptionNote?: InputMaybe<Scalars["String"]>;
...
declare type OrderSurgicalInput = {
    surgicalProcedureTypeId: Scalars["ID"];
    patientChartId: Scalars["ID"];
    appointmentId: Scalars["ID"];
    patientId: Scalars["ID"];
...
declare type OrderTreatmentInput = {
...
declare type OrganizationDetails = {
...
declare type OrganizationDetailsInput = {
...
declare type PastHospitalization = {
...
declare type PastHospitalizationInput = {
    reason: Scalars["String"];
    provider: Scalars["String"];
...
declare type PastHospitalizationUpdateInput = {
    id: Scalars["ID"];
...
declare type PastIllnessInput = {
    title: Scalars["String"];
    description: Scalars["String"];
    patientHistoryId: Scalars["ID"];
};
declare type PastIllnessType = {
    __typename?: "PastIllnessType";
    id: Scalars["ID"];
    title: Scalars["String"];
};
declare type PastIllnessTypeConnection = Connection & {
    __typename?: "PastIllnessTypeConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<Maybe<PastIllnessTypeEdge>>;
};
declare type PastIllnessTypeEdge = {
    __typename?: "PastIllnessTypeEdge";
    node: PastIllnessType;
};
declare type PastIllnessTypeInput = {
    title: Scalars["String"];
};
declare type PastIllnessTypeUpdateInput = {
    id: Scalars["ID"];
    title: Scalars["String"];
};
declare type PastIllnessUpdateInput = {
    id: Scalars["ID"];
    title?: InputMaybe<Scalars["String"]>;
    description?: InputMaybe<Scalars["String"]>;
};
declare type PastInjury = {
...
declare type PastInjuryInput = {
    description: Scalars["String"];
    injuryDate?: InputMaybe<Scalars["Time"]>;
    patientHistoryId: Scalars["ID"];
};
declare type PastInjuryUpdateInput = {
    id: Scalars["ID"];
    description?: InputMaybe<Scalars["String"]>;
    injuryDate?: InputMaybe<Scalars["Time"]>;
};
declare type PastSurgery = {
...
declare type PastSurgeryInput = {
    description: Scalars["String"];
    surgeryDate?: InputMaybe<Scalars["Time"]>;
    patientHistoryId: Scalars["ID"];
};
declare type PastSurgeryUpdateInput = {
    id: Scalars["ID"];
    description?: InputMaybe<Scalars["String"]>;
    surgeryDate?: InputMaybe<Scalars["Time"]>;
};
...
declare type PatientChartConnection = Connection & {
    __typename?: "PatientChartConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<Maybe<PatientChartEdge>>;
};
declare type PatientChartEdge = {
    __typename?: "PatientChartEdge";
    node: PatientChart;
};
declare type PatientChartInput = {
    appointmentId: Scalars["ID"];
...
declare type PatientChartUpdateInput = {
    id: Scalars["ID"];
    temperature?: InputMaybe<Scalars["Float"]>;
    pulse?: InputMaybe<Scalars["Float"]>;
    bloodPressureSystolic?: InputMaybe<Scalars["Float"]>;
...
declare type PatientConnection = Connection & {
    __typename?: "PatientConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<Maybe<PatientEdge>>;
};
declare type PatientDiagnosis = {
...
declare type PatientDiagnosisInput = {
    diagnosisId: Scalars["ID"];
    location?: InputMaybe<Scalars["String"]>;
    differential: Scalars["Boolean"];
    patientChartId: Scalars["ID"];
};
declare type PatientDiagnosisUpdateInput = {
    id: Scalars["ID"];
...
declare type PatientEdge = {
    __typename?: "PatientEdge";
    node: Patient;
};
declare type PatientEncounterLimit = {
...
declare type PatientEncounterLimitUpdateInput = {
    id: Scalars["ID"];
    userId?: InputMaybe<Scalars["ID"]>;
...
declare type PatientHistoryUpdateInput = {
    id: Scalars["ID"];
    reviewOfSystemsNote?: InputMaybe<Scalars["String"]>;
};
declare type PatientInput = {
    firstName: Scalars["String"];
    lastName: Scalars["String"];
    gender: Scalars["String"];
    phoneNo: Scalars["String"];
...
declare type PatientQueueInput = {
    queueName: Scalars["String"];
    queue: Array<Scalars["String"]>;
    queueType: QueueType;
};
declare type PatientQueueWithAppointment = {
...
declare type PatientUpdateInput = {
    id: Scalars["ID"];
    firstName?: InputMaybe<Scalars["String"]>;
    lastName?: InputMaybe<Scalars["String"]>;
...
declare type PaymentConnection = Connection & {
    __typename?: "PaymentConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<Maybe<PaymentEdge>>;
};
declare type PaymentEdge = {
    __typename?: "PaymentEdge";
    node: Payment;
};
declare type PaymentInput = {
    invoiceNo: Scalars["String"];
    billingId: Scalars["ID"];
};
declare type PaymentUpdateInput = {
    id: Scalars["ID"];
    invoiceNo?: InputMaybe<Scalars["String"]>;
    billingId?: InputMaybe<Scalars["ID"]>;
    status?: InputMaybe<Scalars["String"]>;
};
declare type PaymentWaiver = {
...
declare type PaymentWaiverConnection = Connection & {
    __typename?: "PaymentWaiverConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<Maybe<PaymentWaiverEdge>>;
};
declare type PaymentWaiverEdge = {
    __typename?: "PaymentWaiverEdge";
    node: PaymentWaiver;
};
declare type PaymentWaiverInput = {
    paymentId: Scalars["ID"];
    patientId: Scalars["ID"];
    approved?: InputMaybe<Scalars["Boolean"]>;
};
declare type PaymentWaiverUpdateInput = {
    id: Scalars["ID"];
    paymentId?: InputMaybe<Scalars["ID"]>;
    patientId?: InputMaybe<Scalars["ID"]>;
    approved?: InputMaybe<Scalars["Boolean"]>;
};
declare type Pharmacy = {
    __typename?: "Pharmacy";
    id: Scalars["ID"];
    title: Scalars["String"];
    address: Scalars["String"];
...
declare type PharmacyConnection = Connection & {
    __typename?: "PharmacyConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<Maybe<PharmacyEdge>>;
};
declare type PharmacyEdge = {
    __typename?: "PharmacyEdge";
    node: Pharmacy;
};
declare type PharmacyInput = {
    title: Scalars["String"];
    address: Scalars["String"];
    region: Scalars["String"];
    country: Scalars["String"];
...
declare type PharmacyUpdateInput = {
    id: Scalars["ID"];
    title?: InputMaybe<Scalars["String"]>;
    address?: InputMaybe<Scalars["String"]>;
    region?: InputMaybe<Scalars["String"]>;
...
declare type PhysicalExamFinding = {
...
declare type PhysicalExamFindingConnection = Connection & {
    __typename?: "PhysicalExamFindingConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<PhysicalExamFindingEdge>;
};
declare type PhysicalExamFindingEdge = {
    __typename?: "PhysicalExamFindingEdge";
    node: PhysicalExamFinding;
};
declare type PhysicalExamFindingFilter = {
    patientChartId?: InputMaybe<Scalars["ID"]>;
    examCategoryId?: InputMaybe<Scalars["ID"]>;
};
declare type PhysicalExamFindingInput = {
    patientChartId: Scalars["ID"];
    examCategoryId: Scalars["ID"];
    abnormal: Scalars["Boolean"];
    note?: InputMaybe<Scalars["String"]>;
};
declare type PhysicalExamFindingUpdateInput = {
    id: Scalars["ID"];
    patientChartId?: InputMaybe<Scalars["ID"]>;
    examCategoryId?: InputMaybe<Scalars["ID"]>;
...
declare type PlanTypeConnection = Connection & {
    __typename?: "PlanTypeConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<Maybe<PlanTypeEdge>>;
};
declare type PlanTypeEdge = {
    __typename?: "PlanTypeEdge";
    node: PlanType;
};
declare type PlanTypeInput = {
    title: Scalars["String"];
    status: Scalars["String"];
    billingIds: Array<InputMaybe<Scalars["ID"]>>;
};
declare type PrescriptionOrdersFilter = {
    orderedById?: InputMaybe<Scalars["ID"]>;
    status?: InputMaybe<Scalars["String"]>;
};
declare type ProgressNote = {
...
declare type QueryAllergiesArgs = {
    page: PaginationInput;
    filter?: InputMaybe<AllergyFilter>;
};
declare type QueryAmendmentArgs = {
    id: Scalars["ID"];
};
declare type QueryAmendmentsArgs = {
    filter?: InputMaybe<AmendmentFilter>;
};
declare type QueryAppointmentArgs = {
    id: Scalars["ID"];
};
declare type QueryAppointmentsArgs = {
    page: PaginationInput;
    filter?: InputMaybe<AppointmentFilter>;
};
declare type QueryAppointmentStatusesArgs = {
    page: PaginationInput;
};
declare type QueryFindAppointmentsByPatientAndRangeArgs = {
    patientId: Scalars["ID"];
    start: Scalars["Time"];
    end: Scalars["Time"];
};
declare type QueryPatientsAppointmentTodayArgs = {
    patientId: Scalars["ID"];
    checkedIn: Scalars["Boolean"];
};
declare type QueryFindTodaysAppointmentsArgs = {
    page: PaginationInput;
    searchTerm?: InputMaybe<Scalars["String"]>;
};
declare type QueryFindTodaysCheckedInAppointmentsArgs = {
    page: PaginationInput;
    searchTerm?: InputMaybe<Scalars["String"]>;
};
declare type QuerySearchAppointmentsArgs = {
    page: PaginationInput;
    input: AppointmentSearchInput;
};
declare type QueryGetUserAppointmentsArgs = {
    page: PaginationInput;
    searchTerm?: InputMaybe<Scalars["String"]>;
    visitType?: InputMaybe<Scalars["String"]>;
    subscriptions?: InputMaybe<Scalars["Boolean"]>;
};
declare type QueryPayForConsultationArgs = {
    patientId: Scalars["ID"];
    date?: InputMaybe<Scalars["Time"]>;
};
declare type QueryBillingsArgs = {
    page: PaginationInput;
    filter?: InputMaybe<BillingFilter>;
    searchTerm?: InputMaybe<Scalars["String"]>;
};
declare type QueryBillingArgs = {
    id: Scalars["ID"];
};
declare type QueryGetChatMessagesArgs = {
    id: Scalars["ID"];
};
declare type QueryGetChatMembersArgs = {
    id: Scalars["ID"];
};
declare type QueryGetCommonChatArgs = {
    recipientID: Scalars["ID"];
};
declare type QueryChiefComplaintsArgs = {
    page: PaginationInput;
    filter?: InputMaybe<ChiefComplaintFilter>;
};
declare type QuerySearchChiefComplaintsArgs = {
    searchTerm: Scalars["String"];
    page: PaginationInput;
};
declare type QueryChiefComplaintTypeArgs = {
    id: Scalars["ID"];
};
declare type QueryChiefComplaintTypesArgs = {
    page: PaginationInput;
    searchTerm?: InputMaybe<Scalars["String"]>;
    favorites?: InputMaybe<Scalars["Boolean"]>;
};
declare type QueryDiagnosesArgs = {
    page: PaginationInput;
    searchTerm?: InputMaybe<Scalars["String"]>;
    favorites?: InputMaybe<Scalars["Boolean"]>;
};
declare type QueryDiagnosticProcedureArgs = {
    filter: DiagnosticProcedureFilter;
};
declare type QueryDiagnosticProceduresArgs = {
    page: PaginationInput;
    filter?: InputMaybe<DiagnosticProcedureFilter>;
};
declare type QueryDiagnosticProcedureOrderArgs = {
    patientChartId: Scalars["ID"];
};
declare type QuerySearchDiagnosticProcedureOrdersArgs = {
    page: PaginationInput;
    filter?: InputMaybe<DiagnosticProcedureOrderFilter>;
    date?: InputMaybe<Scalars["Time"]>;
    searchTerm?: InputMaybe<Scalars["String"]>;
};
declare type QueryDiagnosticProcedureTypesArgs = {
    page: PaginationInput;
    searchTerm?: InputMaybe<Scalars["String"]>;
};
declare type QueryRefractionArgs = {
    patientChartId: Scalars["ID"];
};
declare type QueryEyewearShopArgs = {
    id: Scalars["ID"];
};
declare type QueryEyewearShopsArgs = {
    page: PaginationInput;
};
declare type QueryFavoriteMedicationsArgs = {
    page: PaginationInput;
    filter?: InputMaybe<FavoriteMedicationFilter>;
    searchTerm?: InputMaybe<Scalars["String"]>;
};
declare type QueryUserFavoriteMedicationsArgs = {
    page: PaginationInput;
    searchTerm?: InputMaybe<Scalars["String"]>;
};
declare type QuerySearchFavoriteMedicationsArgs = {
    searchTerm: Scalars["String"];
    page: PaginationInput;
};
declare type QueryFileArgs = {
    id: Scalars["ID"];
};
declare type QueryFilesArgs = {
    page: PaginationInput;
};
declare type QueryFollowUpArgs = {
    filter: FollowUpFilter;
};
declare type QueryFollowUpsArgs = {
    page: PaginationInput;
    filter?: InputMaybe<FollowUpFilter>;
};
declare type QueryFollowUpOrderArgs = {
    patientChartId: Scalars["ID"];
};
declare type QuerySearchFollowUpOrdersArgs = {
    page: PaginationInput;
    filter?: InputMaybe<FollowUpOrderFilter>;
    date?: InputMaybe<Scalars["Time"]>;
    searchTerm?: InputMaybe<Scalars["String"]>;
};
declare type QueryHpiComponentTypesArgs = {
    page: PaginationInput;
};
declare type QueryHpiComponentsArgs = {
    page: PaginationInput;
    filter?: InputMaybe<HpiFilter>;
    searchTerm?: InputMaybe<Scalars["String"]>;
};
declare type QueryLabsArgs = {
    page: PaginationInput;
    filter?: InputMaybe<LabFilter>;
};
declare type QueryLabTypesArgs = {
    page: PaginationInput;
    searchTerm?: InputMaybe<Scalars["String"]>;
};
declare type QueryLabOrderArgs = {
    patientChartId: Scalars["ID"];
};
declare type QuerySearchLabOrdersArgs = {
    page: PaginationInput;
    filter?: InputMaybe<LabOrderFilter>;
    date?: InputMaybe<Scalars["Time"]>;
    searchTerm?: InputMaybe<Scalars["String"]>;
};
declare type QueryLifestyleTypeArgs = {
    id: Scalars["ID"];
};
declare type QueryLifestyleTypesArgs = {
    page: PaginationInput;
};
declare type QueryOrderArgs = {
    id: Scalars["ID"];
};
declare type QueryOrdersArgs = {
    page: PaginationInput;
    filter?: InputMaybe<OrderFilterInput>;
};
declare type QueryProviderOrdersArgs = {
    page: PaginationInput;
    searchTerm?: InputMaybe<Scalars["String"]>;
};
declare type QueryPastIllnessTypeArgs = {
    id: Scalars["ID"];
};
declare type QueryPastIllnessTypesArgs = {
    page: PaginationInput;
};
declare type QueryPatientArgs = {
    id: Scalars["ID"];
};
declare type QuerySearchPatientsArgs = {
    term: Scalars["String"];
};
declare type QueryGetByCardNoArgs = {
    cardNo: Scalars["String"];
};
declare type QueryGetProgressNotesArgs = {
    appointmentId: Scalars["ID"];
};
declare type QueryGetAllPatientProgressArgs = {
    patientId: Scalars["ID"];
};
declare type QueryGetVitalSignsProgressArgs = {
    patientId: Scalars["ID"];
};
declare type QueryGetPatientDiagnosticProgressArgs = {
    patientId: Scalars["ID"];
    procedureTypeTitle: Scalars["String"];
};
declare type QueryGetPatientDiagnosticProcedureTitlesArgs = {
    patientId: Scalars["ID"];
};
declare type QueryPatientsArgs = {
    page: PaginationInput;
};
declare type QueryGetPatientOrderCountArgs = {
    patientId: Scalars["ID"];
};
declare type QueryGetPatientFilesArgs = {
    patientId: Scalars["ID"];
};
declare type QueryFindSimilarPatientsArgs = {
    input: SimilarPatientsInput;
};
declare type QueryPatientChartArgs = {
    id: Scalars["ID"];
    details?: InputMaybe<Scalars["Boolean"]>;
};
declare type QueryPatientChartsArgs = {
    page: PaginationInput;
};
declare type QueryVitalSignsArgs = {
    filter: VitalSignsFilter;
};
declare type QueryOpthalmologyExamArgs = {
    filter: OphthalmologyExamFilter;
};
declare type QueryPatientDiagnosesArgs = {
    page: PaginationInput;
    filter?: InputMaybe<PatientDiagnosisFilter>;
};
declare type QuerySearchPatientDiagnosisArgs = {
    searchTerm?: InputMaybe<Scalars["String"]>;
    page: PaginationInput;
};
declare type QueryPatientEncounterLimitArgs = {
    id: Scalars["ID"];
};
declare type QueryPatientEncounterLimitsArgs = {
    page: PaginationInput;
};
declare type QueryPatientEncounterLimitByUserArgs = {
    userId: Scalars["ID"];
};
declare type QueryPatientHistoryArgs = {
    id: Scalars["ID"];
};
declare type QueryPastIllnessesArgs = {
    patientHistoryId: Scalars["ID"];
};
declare type QueryPastInjuriesArgs = {
    patientHistoryId: Scalars["ID"];
};
declare type QueryPastHospitalizationsArgs = {
    patientHistoryId: Scalars["ID"];
};
declare type QueryPastSurgeriesArgs = {
    patientHistoryId: Scalars["ID"];
};
declare type QueryLifestylesArgs = {
    patientHistoryId: Scalars["ID"];
};
declare type QueryFamilyIllnessesArgs = {
    patientHistoryId: Scalars["ID"];
};
declare type QueryUserSubscriptionsArgs = {
    userId: Scalars["ID"];
};
declare type QueryPaymentsArgs = {
    page: PaginationInput;
};
declare type QueryPaymentWaiversArgs = {
    page: PaginationInput;
};
declare type QueryPaymentWaiverArgs = {
    id: Scalars["ID"];
};
declare type QueryPharmacyArgs = {
    id: Scalars["ID"];
};
declare type QueryPharmaciesArgs = {
    page: PaginationInput;
};
declare type QueryExamCategoryArgs = {
    id: Scalars["ID"];
};
declare type QueryExamCategoriesArgs = {
    page: PaginationInput;
    searchTerm?: InputMaybe<Scalars["String"]>;
};
declare type QueryExamFindingArgs = {
    id: Scalars["ID"];
};
declare type QueryExamFindingsArgs = {
    page: PaginationInput;
    searchTerm?: InputMaybe<Scalars["String"]>;
};
declare type QueryPhysicalExamFindingArgs = {
    id: Scalars["ID"];
};
declare type QueryPhysicalExamFindingsArgs = {
    page: PaginationInput;
    filter?: InputMaybe<PhysicalExamFindingFilter>;
};
declare type QueryPlanTypesArgs = {
    page: PaginationInput;
};
declare type QuerySearchMedicalPrescriptionsArgs = {
    page: PaginationInput;
    filter?: InputMaybe<MedicalPrescriptionFilter>;
    prescribedDate?: InputMaybe<Scalars["Time"]>;
    searchTerm?: InputMaybe<Scalars["String"]>;
};
declare type QueryMedicationPrescriptionOrderArgs = {
    patientChartId: Scalars["ID"];
};
declare type QueryEyewearPrescriptionOrderArgs = {
    patientChartId: Scalars["ID"];
};
declare type QuerySearchMedicationPrescriptionOrdersArgs = {
    page: PaginationInput;
    filter?: InputMaybe<PrescriptionOrdersFilter>;
    prescribedDate?: InputMaybe<Scalars["Time"]>;
    searchTerm?: InputMaybe<Scalars["String"]>;
};
declare type QuerySearchEyewearPrescriptionOrdersArgs = {
    page: PaginationInput;
    filter?: InputMaybe<PrescriptionOrdersFilter>;
    prescribedDate?: InputMaybe<Scalars["Time"]>;
    searchTerm?: InputMaybe<Scalars["String"]>;
};
declare type QueryReferralArgs = {
    filter: ReferralFilter;
};
declare type QueryReferralsArgs = {
    page: PaginationInput;
    filter?: InputMaybe<ReferralFilter>;
};
declare type QueryReferralOrderArgs = {
    patientChartId: Scalars["ID"];
};
declare type QuerySearchReferralOrdersArgs = {
    page: PaginationInput;
    filter?: InputMaybe<ReferralOrderFilter>;
    date?: InputMaybe<Scalars["Time"]>;
    searchTerm?: InputMaybe<Scalars["String"]>;
};
declare type QuerySystemArgs = {
    id: Scalars["ID"];
};
declare type QuerySystemsArgs = {
    page: PaginationInput;
    searchTerm?: InputMaybe<Scalars["String"]>;
};
declare type QuerySystemSymptomArgs = {
    id: Scalars["ID"];
};
declare type QuerySystemSymptomsArgs = {
    page: PaginationInput;
    searchTerm?: InputMaybe<Scalars["String"]>;
};
declare type QueryReviewOfSystemArgs = {
    id: Scalars["ID"];
};
declare type QueryReviewOfSystemsArgs = {
    page: PaginationInput;
    filter?: InputMaybe<ReviewOfSystemFilter>;
};
declare type QueryRoomsArgs = {
    page: PaginationInput;
};
declare type QuerySearchArgs = {
    searchTerm: Scalars["String"];
};
declare type QuerySuppliesArgs = {
    page: PaginationInput;
    searchTerm?: InputMaybe<Scalars["String"]>;
};
declare type QuerySurgicalProcedureArgs = {
    patientChartId: Scalars["ID"];
};
declare type QuerySurgicalProceduresArgs = {
    page: PaginationInput;
    filter?: InputMaybe<SurgicalProcedureFilter>;
};
declare type QueryGetSurgicalProceduresByPatientArgs = {
    page: PaginationInput;
    patientId: Scalars["ID"];
};
declare type QuerySurgicalProcedureTypesArgs = {
    page: PaginationInput;
    searchTerm?: InputMaybe<Scalars["String"]>;
};
declare type QuerySurgicalOrderArgs = {
    patientChartId: Scalars["ID"];
};
declare type QuerySearchSurgicalOrdersArgs = {
    page: PaginationInput;
    filter?: InputMaybe<SurgicalOrderFilter>;
    date?: InputMaybe<Scalars["Time"]>;
    searchTerm?: InputMaybe<Scalars["String"]>;
};
declare type QueryTreatmentArgs = {
    patientChartId: Scalars["ID"];
};
declare type QueryTreatmentsArgs = {
    page: PaginationInput;
    filter?: InputMaybe<TreatmentFilter>;
};
declare type QueryGetTreatmentsByPatientArgs = {
    page: PaginationInput;
    patientId: Scalars["ID"];
};
declare type QueryTreatmentTypesArgs = {
    page: PaginationInput;
    searchTerm?: InputMaybe<Scalars["String"]>;
};
declare type QueryTreatmentOrderArgs = {
    patientChartId: Scalars["ID"];
};
declare type QuerySearchTreatmentOrdersArgs = {
    page: PaginationInput;
...
declare type QueryUsersArgs = {
    page: PaginationInput;
    filter?: InputMaybe<UserFilter>;
    searchTerm?: InputMaybe<Scalars["String"]>;
};
declare type QueryUserTypesArgs = {
    page: PaginationInput;
};
declare type QuerySearchUsersArgs = {
    input: UserSearchInput;
};
declare type QueryGetByUserTypeTitleArgs = {
    input: Scalars["String"];
};
declare type QueryVisitTypesArgs = {
    page: PaginationInput;
};
declare type QueueSubscription = {
...
declare type ReferralConnection = Connection & {
    __typename?: "ReferralConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<ReferralEdge>;
};
declare type ReferralEdge = {
    __typename?: "ReferralEdge";
    node: Referral;
};
declare type ReferralFilter = {
    id?: InputMaybe<Scalars["ID"]>;
    patientId?: InputMaybe<Scalars["ID"]>;
};
declare type ReferralOrder = {
...
declare type ReferralOrderConnection = Connection & {
    __typename?: "ReferralOrderConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<ReferralOrderEdge>;
};
declare type ReferralOrderEdge = {
    __typename?: "ReferralOrderEdge";
    node: ReferralOrder;
};
declare type ReferralOrderFilter = {
    patientChartId?: InputMaybe<Scalars["ID"]>;
    orderedById?: InputMaybe<Scalars["ID"]>;
    patientId?: InputMaybe<Scalars["ID"]>;
    status?: InputMaybe<Scalars["String"]>;
};
declare enum ReferralOrderStatus {
    Ordered = "ORDERED",
    Completed = "COMPLETED"
}
declare enum ReferralStatus {
    Ordered = "ORDERED",
    Completed = "COMPLETED"
}
...
declare type ReviewOfSystemConnection = Connection & {
    __typename?: "ReviewOfSystemConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<ReviewOfSystemEdge>;
};
declare type ReviewOfSystemEdge = {
    __typename?: "ReviewOfSystemEdge";
    node: ReviewOfSystem;
};
declare type ReviewOfSystemFilter = {
    patientHistoryId?: InputMaybe<Scalars["ID"]>;
    systemSymptomId?: InputMaybe<Scalars["ID"]>;
};
declare type ReviewOfSystemInput = {
    patientHistoryId: Scalars["ID"];
    systemSymptomId: Scalars["ID"];
    note?: InputMaybe<Scalars["String"]>;
};
declare type ReviewOfSystemUpdateInput = {
    id: Scalars["ID"];
    patientHistoryId?: InputMaybe<Scalars["ID"]>;
    systemSymptomId?: InputMaybe<Scalars["ID"]>;
    note?: InputMaybe<Scalars["String"]>;
...
declare type RoomConnection = Connection & {
    __typename?: "RoomConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<Maybe<RoomEdge>>;
};
declare type RoomEdge = Edge & {
    __typename?: "RoomEdge";
    node: Room;
};
declare type RoomInput = {
    title: Scalars["String"];
};
declare type RoomOrder = {
    field: Scalars["String"];
    direction: OrderDirection;
};
declare type ScheduleSurgeryInput = {
    orderId: Scalars["ID"];
    checkInTime: Scalars["Time"];
    roomId: Scalars["ID"];
    invoiceNo: Scalars["String"];
};
declare type ScheduleTreatmentInput = {
    orderId: Scalars["ID"];
    checkInTime: Scalars["Time"];
    roomId: Scalars["ID"];
    invoiceNo: Scalars["String"];
...
declare type SimilarPatients = {
    __typename?: "SimilarPatients";
    byName: Array<Patient>;
    byPhone: Array<Patient>;
};
declare type SimilarPatientsInput = {
    firstName: Scalars["String"];
    lastName: Scalars["String"];
    phoneNo: Scalars["String"];
};
declare type SubscribeInput = {
    userId: Scalars["ID"];
    patientQueueId: Scalars["ID"];
};
...
declare type SupplyConnection = Connection & {
    __typename?: "SupplyConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<Maybe<SupplyEdge>>;
};
declare type SupplyEdge = {
    __typename?: "SupplyEdge";
    node: Supply;
};
declare type SupplyInput = {
    title: Scalars["String"];
    active: Scalars["Boolean"];
    billingIds: Array<InputMaybe<Scalars["ID"]>>;
};
declare enum SupplyStatus {
    Active = "ACTIVE",
    Inactive = "INACTIVE"
}
declare type SupplyUpdateInput = {
    id: Scalars["ID"];
    title?: InputMaybe<Scalars["String"]>;
    active?: InputMaybe<Scalars["Boolean"]>;
    billingIds?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
};
declare enum SurgeryStatus {
    Ordered = "ORDERED",
    Completed = "COMPLETED"
}
declare type SurgicalOrder = {
...
declare type SurgicalOrderConnection = Connection & {
    __typename?: "SurgicalOrderConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<SurgicalOrderEdge>;
};
declare type SurgicalOrderEdge = {
    __typename?: "SurgicalOrderEdge";
    node: SurgicalOrder;
};
declare type SurgicalOrderFilter = {
    patientChartId?: InputMaybe<Scalars["ID"]>;
    orderedById?: InputMaybe<Scalars["ID"]>;
    patientId?: InputMaybe<Scalars["ID"]>;
    status?: InputMaybe<Scalars["String"]>;
};
declare enum SurgicalOrderStatus {
    Ordered = "ORDERED",
    Completed = "COMPLETED"
}
declare type SurgicalProcedure = {
...
declare type SurgicalProcedureConnection = Connection & {
    __typename?: "SurgicalProcedureConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<Maybe<SurgicalProcedureEdge>>;
};
declare type SurgicalProcedureEdge = {
    __typename?: "SurgicalProcedureEdge";
    node: SurgicalProcedure;
};
declare type SurgicalProcedureFilter = {
    patientChartId?: InputMaybe<Scalars["ID"]>;
};
declare type SurgicalProcedureInput = {
    patientChartId: Scalars["ID"];
...
declare type SurgicalProcedureType = {
...
declare type SurgicalProcedureUpdateInput = {
    id: Scalars["ID"];
    respiratory?: InputMaybe<Scalars["String"]>;
    cardiovascular?: InputMaybe<Scalars["String"]>;
    abdomen?: InputMaybe<Scalars["String"]>;
...
declare type SystemConnection = Connection & {
    __typename?: "SystemConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<SystemEdge>;
};
declare type SystemEdge = {
    __typename?: "SystemEdge";
    node: System;
};
declare type SystemInput = {
    title: Scalars["String"];
};
declare type SystemSymptom = {
...
declare type SystemSymptomConnection = Connection & {
    __typename?: "SystemSymptomConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<SystemSymptomEdge>;
};
declare type SystemSymptomEdge = {
    __typename?: "SystemSymptomEdge";
    node: SystemSymptom;
};
declare type SystemSymptomInput = {
    title: Scalars["String"];
    systemId: Scalars["ID"];
};
declare type SystemSymptomUpdateInput = {
    id: Scalars["ID"];
    title?: InputMaybe<Scalars["String"]>;
    systemId?: InputMaybe<Scalars["ID"]>;
};
declare type SystemUpdateInput = {
    id: Scalars["ID"];
    title?: InputMaybe<Scalars["String"]>;
};
declare type Todo = {
...
declare type TreatmentConnection = Connection & {
    __typename?: "TreatmentConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<TreatmentEdge>;
};
declare type TreatmentEdge = {
    __typename?: "TreatmentEdge";
    node: Treatment;
};
declare type TreatmentFilter = {
    patientChartId?: InputMaybe<Scalars["ID"]>;
};
declare type TreatmentInput = {
    patientChartId: Scalars["ID"];
    note?: InputMaybe<Scalars["String"]>;
...
declare type TreatmentOrderConnection = Connection & {
    __typename?: "TreatmentOrderConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<TreatmentOrderEdge>;
};
declare type TreatmentOrderEdge = {
    __typename?: "TreatmentOrderEdge";
    node: TreatmentOrder;
};
declare type TreatmentOrderFilter = {
    patientChartId?: InputMaybe<Scalars["ID"]>;
    orderedById?: InputMaybe<Scalars["ID"]>;
    patientId?: InputMaybe<Scalars["ID"]>;
    status?: InputMaybe<Scalars["String"]>;
};
declare enum TreatmentOrderStatus {
    Ordered = "ORDERED",
    Completed = "COMPLETED"
}
...
declare type TreatmentTypeConnection = Connection & {
    __typename?: "TreatmentTypeConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<Maybe<TreatmentTypeEdge>>;
};
declare type TreatmentTypeEdge = {
    __typename?: "TreatmentTypeEdge";
    node: TreatmentType;
};
declare type TreatmentTypeInput = {
    title: Scalars["String"];
    active: Scalars["Boolean"];
    billingIds: Array<InputMaybe<Scalars["ID"]>>;
    supplyIds: Array<InputMaybe<Scalars["ID"]>>;
};
declare type TreatmentTypeUpdateInput = {
    id: Scalars["ID"];
    title?: InputMaybe<Scalars["String"]>;
    active?: InputMaybe<Scalars["Boolean"]>;
    billingIds?: InputMaybe<Array<InputMaybe<Scalars["ID"]>>>;
...
declare type TreatmentUpdateInput = {
    id: Scalars["ID"];
    note?: InputMaybe<Scalars["String"]>;
    result?: InputMaybe<Scalars["String"]>;
    rightEyeText?: InputMaybe<Scalars["String"]>;
...
declare type UserConnection = Connection & {
...
declare type UserTypeConnection = Connection & {
    __typename?: "UserTypeConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<Maybe<UserTypeEdge>>;
};
declare type UserTypeEdge = {
    __typename?: "UserTypeEdge";
    node: UserType;
};
declare type UserTypeInput = {
    title: Scalars["String"];
};
declare type UserTypeUpdateInput = {
    id: Scalars["ID"];
    title: Scalars["String"];
};
declare type UserUpdateInput = {
    id: Scalars["ID"];
    firstName: Scalars["String"];
    lastName: Scalars["String"];
    email: Scalars["String"];
...
declare type VisitType = {
    __typename?: "VisitType";
    id: Scalars["Int"];
    title: Scalars["String"];
};
declare type VisitTypeConnection = Connection & {
    __typename?: "VisitTypeConnection";
    totalCount: Scalars["Int"];
    pageInfo: PageInfo;
    edges: Array<Maybe<VisitTypeEdge>>;
};
declare type VisitTypeEdge = {
    __typename?: "VisitTypeEdge";
    node: VisitType;
};
declare type VisitTypeInput = {
    title?: InputMaybe<Scalars["String"]>;
};
declare type VisitTypeOrder = {
    field: Scalars["String"];
    direction: OrderDirection;
};
declare type VitalSigns = {
...
declare type VitalSignsFilter = {
    id?: InputMaybe<Scalars["ID"]>;
    patientChartId?: InputMaybe<Scalars["ID"]>;
};
declare type VitalSignsInput = {
    patientChartId: Scalars["ID"];
    temperature?: InputMaybe<Scalars["Float"]>;
    pulse?: InputMaybe<Scalars["Float"]>;
    bloodPressureSystolic?: InputMaybe<Scalars["Float"]>;
...
declare type VitalSignsProgress = {
    __typename?: "VitalSignsProgress";
    appointments: Array<Maybe<Appointment>>;
};
declare type VitalSignsUpdateInput = {
    id: Scalars["ID"];
    temperature?: InputMaybe<Scalars["Float"]>;
    pulse?: InputMaybe<Scalars["Float"]>;
    bloodPressureSystolic?: InputMaybe<Scalars["Float"]>;
...
declare type Dragging = {
    id: DraggableId;
    location: DraggableLocation;
};
declare type QuoteMap = {
    [key: string]: Quote[];
};
declare type Task = {
    id: Id;
...
export { Allergy, AllergyConnection, AllergyEdge, AllergyFilter, AllergyInput, AllergyUpdateInput, Amendment, AmendmentFilter, AmendmentInput, AmendmentUpdateInput, Appointment, AppointmentConnection, AppointmentEdge, AppointmentFilter, AppointmentInput, AppointmentSearchInput, AppointmentStatus, AppointmentStatusConnection, AppointmentStatusEdge, AppointmentStatusInput, AppointmentUpdateInput, Author, AuthorColors, BILLINGS, Billing, BillingConnection, BillingEdge, BillingFilter, BillingInput, BottomSheetProvider, ChangePasswordInput, Chat, ChatDelete, ChatInput, ChatMember, ChatMessage, ChatMessageInput, ChatMute, ChatUnreadMessage, ChiefComplaint, ChiefComplaintConnection, ChiefComplaintEdge, ChiefComplaintFilter, ChiefComplaintInput, ChiefComplaintOrder, ChiefComplaintType, ChiefComplaintTypeConnection, ChiefComplaintTypeEdge, ChiefComplaintTypeInput, ChiefComplaintTypeUpdateInput, ChiefComplaintUpdateInput, ConfirmFollowOrderInput, ConfirmFollowUpOrderInput, ConfirmFollowUpOrderResult, ConfirmReferralOrderInput, ConfirmReferralOrderResult, ConfirmSurgicalOrderInput, ConfirmSurgicalOrderResult, ConfirmTreatmentOrderInput, ConfirmTreatmentOrderResult, Connection, Destination, Diagnosis, DiagnosisConnection, DiagnosisEdge, DiagnosisInput, DiagnosisOrder, DiagnosisUpdateInput, DiagnosticProcedure, DiagnosticProcedureConnection, DiagnosticProcedureDeleteFileInput, DiagnosticProcedureEdge, DiagnosticProcedureFilter, DiagnosticProcedureInput, DiagnosticProcedureOrder, DiagnosticProcedureOrderConnection, DiagnosticProcedureOrderEdge, DiagnosticProcedureOrderFilter, DiagnosticProcedureOrderStatus, DiagnosticProcedureOrderUpdateInput, DiagnosticProcedureStatus, DiagnosticProcedureType, DiagnosticProcedureTypeConnection, DiagnosticProcedureTypeEdge, DiagnosticProcedureTypeInput, DiagnosticProcedureTypeUpdateInput, DiagnosticProcedureUpdateInput, Dragging, Edge, Exact, ExamCategory, ExamCategoryConnection, ExamCategoryEdge, ExamCategoryInput, ExamCategoryUpdateInput, ExamFinding, ExamFindingConnection, ExamFindingEdge, ExamFindingInput, ExamFindingUpdateInput, EyewearPrescription, EyewearPrescriptionConnection, EyewearPrescriptionEdge, EyewearPrescriptionFilter, EyewearPrescriptionInput, EyewearPrescriptionOrder, EyewearPrescriptionOrderConnection, EyewearPrescriptionOrderEdge, EyewearPrescriptionOrderUpdateInput, EyewearPrescriptionUpdateInput, EyewearShop, EyewearShopConnection, EyewearShopEdge, EyewearShopInput, EyewearShopUpdateInput, FIND_TODAYS_CHECKED_IN_APPOINTMENTS, FamilyIllness, FamilyIllnessInput, FamilyIllnessUpdateInput, FavoriteChiefComplaint, FavoriteDiagnosis, FavoriteMedication, FavoriteMedicationConnection, FavoriteMedicationEdge, FavoriteMedicationFilter, FavoriteMedicationInput, FavoriteMedicationUpdateInput, File, FileConnection, FileEdge, FileInput, FileUpdateInput, FileUpload, FollowUp, FollowUpConnection, FollowUpEdge, FollowUpFilter, FollowUpInput, FollowUpOrder, FollowUpOrderConnection, FollowUpOrderEdge, FollowUpOrderFilter, FollowUpOrderStatus, FollowUpStatus, FollowUpUpdateInput, HealthCheckReport, HomeStats, HpiComponent, HpiComponentConnection, HpiComponentEdge, HpiComponentInput, HpiComponentType, HpiComponentTypeConnection, HpiComponentTypeEdge, HpiComponentTypeInput, HpiComponentTypeOrder, HpiComponentTypeUpdateInput, HpiComponentUpdateInput, HpiFilter, Id, InputMaybe, Lab, LabConnection, LabDeleteFileInput, LabEdge, LabFilter, LabInput, LabOrder, LabOrderConnection, LabOrderEdge, LabOrderFilter, LabOrderStatus, LabOrderUpdateInput, LabStatus, LabType, LabTypeConnection, LabTypeEdge, LabTypeInput, LabTypeUpdateInput, LabUpdateInput, Lifestyle, LifestyleInput, LifestyleType, LifestyleTypeConnection, LifestyleTypeEdge, LifestyleTypeInput, LifestyleTypeUpdateInput, LifestyleUpdateInput, LoginInput, MEDICATION_PRESCRIPTIONS, MakeMaybe, MakeOptional, Maybe, MedicalPrescription, MedicalPrescriptionConnection, MedicalPrescriptionEdge, MedicalPrescriptionFilter, MedicalPrescriptionInput, MedicalPrescriptionOrder, MedicalPrescriptionOrderConnection, MedicalPrescriptionOrderEdge, MedicalPrescriptionOrderInput, MedicalPrescriptionUpdateInput, MedicationPrescriptionUpdateInput, Mutation, MutationApprovePaymentWaiverArgs, MutationChangePasswordArgs, MutationCheckInPatientArgs, MutationCheckOutPatientArgs, MutationConfirmDiagnosticProcedureOrderArgs, MutationConfirmFollowUpOrderArgs, MutationConfirmLabOrderArgs, MutationConfirmOrderArgs, MutationConfirmPaymentArgs, MutationConfirmPaymentsArgs, MutationConfirmReferralOrderArgs, MutationConfirmSurgicalOrderArgs, MutationConfirmTreatmentOrderArgs, MutationCreateAmendmentArgs, MutationCreateChatArgs, MutationCreateEyewearShopArgs, MutationCreatePharmacyArgs, MutationCreateTodoArgs, MutationDeleteAllergyArgs, MutationDeleteAmendmentArgs, MutationDeleteAppointmentArgs, MutationDeleteAppointmentStatusArgs, MutationDeleteBillingArgs, MutationDeleteChatArgs, MutationDeleteChiefComplaintArgs, MutationDeleteChiefComplaintTypeArgs, MutationDeleteDiagnosisArgs, MutationDeleteDiagnosticDocumentArgs, MutationDeleteDiagnosticImageArgs, MutationDeleteDiagnosticLeftEyeImageArgs, MutationDeleteDiagnosticLeftEyeSketchArgs, MutationDeleteDiagnosticProcedureArgs, MutationDeleteDiagnosticProcedureTypeArgs, MutationDeleteDiagnosticRightEyeImageArgs, MutationDeleteDiagnosticRightEyeSketchArgs, MutationDeleteEyewearPrescriptionArgs, MutationDeleteEyewearShopArgs, MutationDeleteFamilyIllnessArgs, MutationDeleteFavoriteChiefComplaintArgs, MutationDeleteFavoriteDiagnosisArgs, MutationDeleteFavoriteMedicationArgs, MutationDeleteFileArgs, MutationDeleteFollowUpArgs, MutationDeleteFromQueueArgs, MutationDeleteHpiComponentArgs, MutationDeleteHpiComponentTypeArgs, MutationDeleteLabArgs, MutationDeleteLabDocumentArgs, MutationDeleteLabImageArgs, MutationDeleteLabLeftEyeImageArgs, MutationDeleteLabLeftEyeSketchArgs, MutationDeleteLabRightEyeImageArgs, MutationDeleteLabRightEyeSketchArgs, MutationDeleteLabTypeArgs, MutationDeleteLifestyleArgs, MutationDeleteLifestyleTypeArgs, MutationDeleteMedicalPrescriptionArgs, MutationDeleteOrderArgs, MutationDeletePastHospitalizationArgs, MutationDeletePastIllnessArgs, MutationDeletePastIllnessTypeArgs, MutationDeletePastInjuryArgs, MutationDeletePastSurgeryArgs, MutationDeletePatientArgs, MutationDeletePatientChartArgs, MutationDeletePatientChiefComplaintArgs, MutationDeletePatientDiagnosisArgs, MutationDeletePatientEncounterLimitArgs, MutationDeletePaymentArgs, MutationDeletePaymentWaiverArgs, MutationDeletePharmacyArgs, MutationDeletePhysicalExamFindingArgs, MutationDeletePhysicalExamFindingExamCategoryArgs, MutationDeletePlanTypeArgs, MutationDeletePreanestheticDocumentArgs, MutationDeleteReferralArgs, MutationDeleteReviewOfSystemArgs, MutationDeleteRoomArgs, MutationDeleteSupplyArgs, MutationDeleteSurgicalProcedureArgs, MutationDeleteSurgicalProcedureTypeArgs, MutationDeleteTreatmentArgs, MutationDeleteTreatmentTypeArgs, MutationDeleteUnreadMessagesArgs, MutationDeleteUserTypeArgs, MutationDeleteVisitTypeArgs, MutationLockPatientChartArgs, MutationLoginArgs, MutationMovePatientQueueArgs, MutationMuteChatArgs, MutationNewAppointmentArgs, MutationOrderAndConfirmDiagnosticProcedureArgs, MutationOrderAndConfirmLabArgs, MutationOrderAndConfirmSurgeryArgs, MutationOrderDiagnosticProcedureArgs, MutationOrderFollowUpArgs, MutationOrderFollowupArgs, MutationOrderLabArgs, MutationOrderReferralArgs, MutationOrderSurgicalProcedureArgs, MutationOrderTreatmentArgs, MutationPushPatientQueueArgs, MutationRequestPaymentWaiverArgs, MutationRequestPaymentWaiversArgs, MutationResetPasswordArgs, MutationSaveAllergyArgs, MutationSaveAppointmentStatusArgs, MutationSaveBillingArgs, MutationSaveChiefComplaintArgs, MutationSaveChiefComplaintTypeArgs, MutationSaveDiagnosisArgs, MutationSaveDiagnosticProcedureArgs, MutationSaveDiagnosticProcedureTypeArgs, MutationSaveExamCategoryArgs, MutationSaveExamFindingArgs, MutationSaveEyewearPrescriptionArgs, MutationSaveFamilyIllnessArgs, MutationSaveFavoriteChiefComplaintArgs, MutationSaveFavoriteDiagnosisArgs, MutationSaveFavoriteMedicationArgs, MutationSaveFileArgs, MutationSaveFollowUpArgs, MutationSaveHpiComponentArgs, MutationSaveHpiComponentTypeArgs, MutationSaveLabArgs, MutationSaveLabTypeArgs, MutationSaveLifestyleArgs, MutationSaveLifestyleTypesArgs, MutationSaveMedicationPrescriptionArgs, MutationSaveOphthalmologyExamArgs, MutationSaveOrderArgs, MutationSaveOrganizationDetailsArgs, MutationSavePastHospitalizationArgs, MutationSavePastIllnessArgs, MutationSavePastIllnessTypesArgs, MutationSavePastInjuryArgs, MutationSavePastMedicationArgs, MutationSavePastSurgeryArgs, MutationSavePatientArgs, MutationSavePatientChartArgs, MutationSavePatientChiefComplaintArgs, MutationSavePatientDiagnosisArgs, MutationSavePatientEncounterLimitArgs, MutationSavePatientQueueArgs, MutationSavePaymentArgs, MutationSavePaymentWaiverArgs, MutationSavePhysicalExamFindingArgs, MutationSavePlanTypeArgs, MutationSaveReviewOfSystemArgs, MutationSaveRoomArgs, MutationSaveSupplyArgs, MutationSaveSurgicalProcedureArgs, MutationSaveSurgicalProcedureTypeArgs, MutationSaveSystemArgs, MutationSaveSystemSymptomArgs, MutationSaveTreatmentArgs, MutationSaveTreatmentTypeArgs, MutationSaveUserTypeArgs, MutationSaveVisitTypeArgs, MutationSaveVitalSignsArgs, MutationScheduleSurgeryArgs, MutationScheduleTreatmentArgs, MutationSendMessageArgs, MutationSignupArgs, MutationSubscribeQueueArgs, MutationUnmuteChatArgs, MutationUnsubscribeQueueArgs, MutationUpdateAllergyArgs, MutationUpdateAmendmentArgs, MutationUpdateAppointmentArgs, MutationUpdateAppointmentStatusArgs, MutationUpdateBillingArgs, MutationUpdateChiefComplaintArgs, MutationUpdateChiefComplaintTypeArgs, MutationUpdateDiagnosisArgs, MutationUpdateDiagnosticProcedureArgs, MutationUpdateDiagnosticProcedureOrderArgs, MutationUpdateDiagnosticProcedureTypeArgs, MutationUpdateExamCategoryArgs, MutationUpdateExamFindingArgs, MutationUpdateEyewearPrescriptionArgs, MutationUpdateEyewearPrescriptionOrderArgs, MutationUpdateEyewearShopArgs, MutationUpdateFamilyIllnessArgs, MutationUpdateFavoriteMedicationArgs, MutationUpdateFileArgs, MutationUpdateFollowUpArgs, MutationUpdateHpiComponentArgs, MutationUpdateHpiComponentTypeArgs, MutationUpdateLabArgs, MutationUpdateLabOrderArgs, MutationUpdateLabTypeArgs, MutationUpdateLifestyleArgs, MutationUpdateLifestyleTypeArgs, MutationUpdateMedicationPrescriptionArgs, MutationUpdateMedicationPrescriptionOrderArgs, MutationUpdateOphthalmologyExamArgs, MutationUpdateOrderArgs, MutationUpdatePastHospitalizationArgs, MutationUpdatePastIllnessArgs, MutationUpdatePastIllnessTypeArgs, MutationUpdatePastInjuryArgs, MutationUpdatePastSurgeryArgs, MutationUpdatePatientArgs, MutationUpdatePatientChartArgs, MutationUpdatePatientDiagnosisArgs, MutationUpdatePatientEncounterLimitArgs, MutationUpdatePatientHistoryArgs, MutationUpdatePatientQueueArgs, MutationUpdatePaymentArgs, MutationUpdatePaymentWaiverArgs, MutationUpdatePharmacyArgs, MutationUpdatePhysicalExamFindingArgs, MutationUpdatePlanTypeArgs, MutationUpdateReviewOfSystemArgs, MutationUpdateRoomArgs, MutationUpdateSupplyArgs, MutationUpdateSurgeryFitnessArgs, MutationUpdateSurgicalProcedureArgs, MutationUpdateSurgicalProcedureTypeArgs, MutationUpdateSystemArgs, MutationUpdateSystemSymptomArgs, MutationUpdateTreatmentArgs, MutationUpdateTreatmentTypeArgs, MutationUpdateUserArgs, MutationUpdateUserTypeArgs, MutationUpdateVisitTypeArgs, MutationUpdateVitalSignsArgs, NewTodo, Notif, NotifType, Notification, NotificationProvider, OphthalmologyExamFilter, OpthalmologyExam, OpthalmologyExamInput, OpthalmologyExamUpdateInput, Order, OrderAndConfirmDiagnosticProcedureInput, OrderAndConfirmLabInput, OrderAndConfirmSurgicalProcedureInput, OrderConnection, OrderDiagnosticProcedureInput, OrderDirection, OrderEdge, OrderFilterInput, OrderFollowUpInput, OrderFollowupInput, OrderInput, OrderLabInput, OrderReferralInput, OrderSurgicalInput, OrderTreatmentInput, OrderUpdateInput, OrdersCount, OrganizationDetails, OrganizationDetailsInput, Page, PageInfo, PaginationInput, PastHospitalization, PastHospitalizationInput, PastHospitalizationUpdateInput, PastIllness, PastIllnessInput, PastIllnessType, PastIllnessTypeConnection, PastIllnessTypeEdge, PastIllnessTypeInput, PastIllnessTypeUpdateInput, PastIllnessUpdateInput, PastInjury, PastInjuryInput, PastInjuryUpdateInput, PastSurgery, PastSurgeryInput, PastSurgeryUpdateInput, Patient, PatientChart, PatientChartConnection, PatientChartEdge, PatientChartInput, PatientChartUpdateInput, PatientConnection, PatientDiagnosis, PatientDiagnosisConnection, PatientDiagnosisEdge, PatientDiagnosisFilter, PatientDiagnosisInput, PatientDiagnosisUpdateInput, PatientEdge, PatientEncounterLimit, PatientEncounterLimitConnection, PatientEncounterLimitEdge, PatientEncounterLimitInput, PatientEncounterLimitUpdateInput, PatientHistory, PatientHistoryUpdateInput, PatientInput, PatientQueue, PatientQueueInput, PatientQueueWithAppointment, PatientUpdateInput, Payment, PaymentConnection, PaymentEdge, PaymentInput, PaymentUpdateInput, PaymentWaiver, PaymentWaiverConnection, PaymentWaiverEdge, PaymentWaiverInput, PaymentWaiverUpdateInput, Pharmacy, PharmacyConnection, PharmacyEdge, PharmacyInput, PharmacyUpdateInput, PhysicalExamFinding, PhysicalExamFindingConnection, PhysicalExamFindingEdge, PhysicalExamFindingFilter, PhysicalExamFindingInput, PhysicalExamFindingUpdateInput, PlanType, PlanTypeConnection, PlanTypeEdge, PlanTypeInput, PrescriptionOrdersFilter, ProgressNote, Query, QueryAllergiesArgs, QueryAmendmentArgs, QueryAmendmentsArgs, QueryAppointmentArgs, QueryAppointmentStatusesArgs, QueryAppointmentsArgs, QueryBillingArgs, QueryBillingsArgs, QueryChiefComplaintTypeArgs, QueryChiefComplaintTypesArgs, QueryChiefComplaintsArgs, QueryDiagnosesArgs, QueryDiagnosticProcedureArgs, QueryDiagnosticProcedureOrderArgs, QueryDiagnosticProcedureTypesArgs, QueryDiagnosticProceduresArgs, QueryExamCategoriesArgs, QueryExamCategoryArgs, QueryExamFindingArgs, QueryExamFindingsArgs, QueryEyewearPrescriptionOrderArgs, QueryEyewearShopArgs, QueryEyewearShopsArgs, QueryFamilyIllnessesArgs, QueryFavoriteMedicationsArgs, QueryFileArgs, QueryFilesArgs, QueryFindAppointmentsByPatientAndRangeArgs, QueryFindSimilarPatientsArgs, QueryFindTodaysAppointmentsArgs, QueryFindTodaysCheckedInAppointmentsArgs, QueryFollowUpArgs, QueryFollowUpOrderArgs, QueryFollowUpsArgs, QueryGetAllPatientProgressArgs, QueryGetByCardNoArgs, QueryGetByUserTypeTitleArgs, QueryGetChatMembersArgs, QueryGetChatMessagesArgs, QueryGetCommonChatArgs, QueryGetPatientDiagnosticProcedureTitlesArgs, QueryGetPatientDiagnosticProgressArgs, QueryGetPatientFilesArgs, QueryGetPatientOrderCountArgs, QueryGetProgressNotesArgs, QueryGetSurgicalProceduresByPatientArgs, QueryGetTreatmentsByPatientArgs, QueryGetUserAppointmentsArgs, QueryGetVitalSignsProgressArgs, QueryHpiComponentTypesArgs, QueryHpiComponentsArgs, QueryLabOrderArgs, QueryLabTypesArgs, QueryLabsArgs, QueryLifestyleTypeArgs, QueryLifestyleTypesArgs, QueryLifestylesArgs, QueryMedicationPrescriptionOrderArgs, QueryOpthalmologyExamArgs, QueryOrderArgs, QueryOrdersArgs, QueryPastHospitalizationsArgs, QueryPastIllnessTypeArgs, QueryPastIllnessTypesArgs, QueryPastIllnessesArgs, QueryPastInjuriesArgs, QueryPastSurgeriesArgs, QueryPatientArgs, QueryPatientChartArgs, QueryPatientChartsArgs, QueryPatientDiagnosesArgs, QueryPatientEncounterLimitArgs, QueryPatientEncounterLimitByUserArgs, QueryPatientEncounterLimitsArgs, QueryPatientHistoryArgs, QueryPatientsAppointmentTodayArgs, QueryPatientsArgs, QueryPayForConsultationArgs, QueryPaymentWaiverArgs, QueryPaymentWaiversArgs, QueryPaymentsArgs, QueryPharmaciesArgs, QueryPharmacyArgs, QueryPhysicalExamFindingArgs, QueryPhysicalExamFindingsArgs, QueryPlanTypesArgs, QueryProviderOrdersArgs, QueryReferralArgs, QueryReferralOrderArgs, QueryReferralsArgs, QueryRefractionArgs, QueryReviewOfSystemArgs, QueryReviewOfSystemsArgs, QueryRoomsArgs, QuerySearchAppointmentsArgs, QuerySearchArgs, QuerySearchChiefComplaintsArgs, QuerySearchDiagnosticProcedureOrdersArgs, QuerySearchEyewearPrescriptionOrdersArgs, QuerySearchFavoriteMedicationsArgs, QuerySearchFollowUpOrdersArgs, QuerySearchLabOrdersArgs, QuerySearchMedicalPrescriptionsArgs, QuerySearchMedicationPrescriptionOrdersArgs, QuerySearchPatientDiagnosisArgs, QuerySearchPatientsArgs, QuerySearchReferralOrdersArgs, QuerySearchSurgicalOrdersArgs, QuerySearchTreatmentOrdersArgs, QuerySearchUsersArgs, QuerySuppliesArgs, QuerySurgicalOrderArgs, QuerySurgicalProcedureArgs, QuerySurgicalProcedureTypesArgs, QuerySurgicalProceduresArgs, QuerySystemArgs, QuerySystemSymptomArgs, QuerySystemSymptomsArgs, QuerySystemsArgs, QueryTreatmentArgs, QueryTreatmentOrderArgs, QueryTreatmentTypesArgs, QueryTreatmentsArgs, QueryUserArgs, QueryUserFavoriteMedicationsArgs, QueryUserSubscriptionsArgs, QueryUserTypesArgs, QueryUsersArgs, QueryVisitTypesArgs, QueryVitalSignsArgs, QueueSubscription, QueueType, Quote, QuoteMap, Referral, ReferralConnection, ReferralEdge, ReferralFilter, ReferralOrder, ReferralOrderConnection, ReferralOrderEdge, ReferralOrderFilter, ReferralOrderStatus, ReferralStatus, ReferralType, ReviewOfSystem, ReviewOfSystemConnection, ReviewOfSystemEdge, ReviewOfSystemFilter, ReviewOfSystemInput, ReviewOfSystemUpdateInput, Room, RoomConnection, RoomEdge, RoomInput, RoomOrder, SHOULD_PAY_FOR_CONSULTATION, SUPPLIES, Scalars, ScheduleSurgeryInput, ScheduleTreatmentInput, SearchResult, SimilarPatients, SimilarPatientsInput, SubscribeInput, Subscription, Supply, SupplyConnection, SupplyEdge, SupplyInput, SupplyStatus, SupplyUpdateInput, SurgeryStatus, SurgicalOrder, SurgicalOrderConnection, SurgicalOrderEdge, SurgicalOrderFilter, SurgicalOrderStatus, SurgicalProcedure, SurgicalProcedureConnection, SurgicalProcedureEdge, SurgicalProcedureFilter, SurgicalProcedureInput, SurgicalProcedureType, SurgicalProcedureTypeConnection, SurgicalProcedureTypeEdge, SurgicalProcedureTypeInput, SurgicalProcedureTypeUpdateInput, SurgicalProcedureUpdateInput, System, SystemConnection, SystemEdge, SystemInput, SystemSymptom, SystemSymptomConnection, SystemSymptomEdge, SystemSymptomInput, SystemSymptomUpdateInput, SystemUpdateInput, Tab, Task, Todo, Treatment, TreatmentConnection, TreatmentEdge, TreatmentFilter, TreatmentInput, TreatmentOrder, TreatmentOrderConnection, TreatmentOrderEdge, TreatmentOrderFilter, TreatmentOrderStatus, TreatmentStatus, TreatmentType, TreatmentTypeConnection, TreatmentTypeEdge, TreatmentTypeInput, TreatmentTypeUpdateInput, TreatmentUpdateInput, User, UserConnection, UserEdge, UserFilter, UserInput, UserSearchInput, UserType, UserTypeConnection, UserTypeEdge, UserTypeInput, UserTypeUpdateInput, UserUpdateInput, VisitType, VisitTypeConnection, VisitTypeEdge, VisitTypeInput, VisitTypeOrder, VitalSigns, VitalSignsFilter, VitalSignsInput, VitalSignsProgress, VitalSignsUpdateInput, useBottomSheetDispatch, useBottonSheetState, useNotificationDispatch, useNotificationState, vitalSignsFragment };
