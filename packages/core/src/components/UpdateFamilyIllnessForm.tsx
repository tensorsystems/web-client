...
export const UpdateFamilyIllnessForm: React.FC<UpdateFamilyIllnessProps> = ({
  values,
  onSuccess,
  onCancel,
  onSaveChange
  ...
  const [save, { error }] = useMutation<any, MutationUpdateFamilyIllnessArgs>(
    UPDATE_FAMILY_ILLNESS,
    {
      onCompleted(data) {
  ...
  const onSubmit = (data: FamilyIllnessUpdateInput) => {
