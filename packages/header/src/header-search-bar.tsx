...
import { Appointment, MedicalPrescription, Page,QuerySearchArgs, Maybe, Patient, Query, User } from "@tensoremr/models";
...
function SearchBarAppointments(props: SearchBarAppointmentsProps) {
...
function SearchBarMedications(props: SearchBarMedicationsProps) {
